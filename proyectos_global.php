    ...
    <div class="w-full h-screen bg-white pt-20">
        ...
        <div class="flex justify-center items-center mb-5 relative pt-4">
            <div class="font-light text-xl ml-3 leading-none text-bluegray-600 mr-8">
                <h1>Proyectos (Global)</h1>
                <h1 id="loadProyectos" class="text-center text-purple-400 my-2 text-2xl"></h1>
            </div>
        ...
        <div class="w-full h-auto">
            <div class="flex flex-col container mx-auto scrollbar">
                <div class="-my-2 py-2 overflow-x-auto  scrollbar">
                    <div class="align-middle inline-block w-full shadow-md overflow-auto sm:rounded-lg border-b border-gray-200 scrollbar" style="max-height: 80vh;">
                        <table class="w-full divide-y divide-gray-200 table table-fixed sortable">
                            <thead>

...
<body class="bg-gray-200" style="font-family: 'Roboto', sans-serif;">
                    ...
                    <div>
                        ...
                        <div id="btnExpandirMenutoggle"
                            ...
                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="toggleModalTailwind('modalExportarSubsecciones')">Subsecciones (EXCEL)</a>

                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="mostrarOcultar('exportarEXCEL','exportarPDF'); toggleModalTailwind('modalExportarSeccionesUsuarios')">Colaborador
                                (EXCEL)</a>
                            ...
                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="mostrarOcultar('exportarPDF','exportarEXCEL'); toggleModalTailwind('modalExportarSeccionesUsuarios')">Colaborador(PDF)</a>
                        </div>
                    </div>
    ...
    <div id="modalMCN" class="modal">
        <div class="modal-window rounded-md pt-10 w-full h:w-10/12">
            <!-- BOTON CERRARL -->
            <div class="absolute top-0 right-0">
                <button onclick="cerrarmodal('modalMCN')"
                    class="cursor-pointer text-md  text-red-500  bg-red-200 px-2 rounded-bl-md rounded-tr-md font-normal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
    ...
    <div id="modalMCF" class="modal">
        <div class="modal-window rounded-md pt-10 w-full h:w-10/12">
            <!-- BOTON CERRARL -->
            <div class="absolute top-0 right-0">
                <button onclick="cerrarmodal('modalMCF')"
                    class="cursor-pointer text-md  text-red-500  bg-red-200 px-2 rounded-bl-md rounded-tr-md font-normal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            ...
            <div class="p-2 flex justify-center items-center flex-col w-full">
                ...
                <div class="mt-2 w-full flex flex-col justify-center items-center px-10">
                    ...
                    <div
                        ...
                        <!-- FALLA -->
                        <div
                            class="w-full h-full flex flex-row items-center justify-between bg-green-100 text-green-500 rounded-l-md cursor-pointer hover:shadow-md border-l-4 border-green-200 relative">
                        ...
                        <!--  STATUS -->
                        <div
                            class="w-32 flex h-full items-center justify-center hover:shadow-md hover:bg-red-200 text-red-500 rounded-r-md">
    ...
    <div id="modalResponsable" class="modal">
        <div class="modal-window rounded-md pt-10" style="width: 370px;">
            <!-- BOTON CERRARL -->
            <div class="absolute top-0 right-0">
                <button onclick="cerrarmodal('modalResponsable')"
                    class="cursor-pointer text-md  text-red-500  bg-red-200 px-2 rounded-bl-md rounded-tr-md font-normal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
    ...
    <div id="modalExportarSubsecciones" class="modal">
        <div class="modal-window rounded-md pt-10" style="width: 370px;">
            <!-- BOTON CERRARL -->
            <div class="absolute top-0 right-0">
                <button onkeydown="cerrarmodal('modalExportarSubsecciones')"
                    class="cursor-pointer text-md  text-red-500  bg-red-200 px-2 rounded-bl-md rounded-tr-md font-normal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            ...
            <div class="p-2 flex flex-col justify-center items-center flex-col w-full pb-6">
                <div class="mb-3 w-full">
                    <input id="palabraUsuario"
                        ...
                        type="search" name="search" placeholder="Buscar..." onkeydown=" obtenerUsuarios();"
                        autocomplete="off">
                </div>

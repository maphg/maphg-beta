...
<body class="bg-gray-200" style="font-family: 'Roboto', sans-serif;">
    ...
    <div class="flex flex-col justify-evenly items-center w-screen h-screen">
        ...
        <div class="scroll flex flex-row justify-start items-start w-full overflow-x-auto py-24 px-4">
            <div class="flex flex-col flex-wrap justify-center items-center w-22rem leading-none text-bluegray-100 mr-4">
                ...
                <div class="flex flex-col justify-end mt-6 items-end w-full pr-10">
                    ...
                    <div class="flex flex-row items-center justify-end mb-2">
                        ...
                        <h1 onclick="botones('aut');" id="btn-auto" class="w-8 h-8 btn-inactivo text-xs rounded-md flex flex-row justify-center items-center font-semibold mr-2 cursor-pointer hover:bg-gray-800 hover:text-gray-100">
                            AUT
                        </h1>
                    </div>
            ...
            <div id="coldep" class="hidden scrollbar flex flex-col justify-center items-center w-22rem mr-4">
                <div class="bg-white shadow-lg rounded-lg px-3 py-1 flex flex-col items-center justify-center w-full relative mh">
                    <div class="flex justify-center items-center absolute top-20 bg-gray-800 shadow-md rounded-lg w-12 h-12">
                    ...
                    <div class="w-full flex flex-col justify-between overflow-y-auto mt-3 scrollbar">
                        ...
                        <div class="flex flex-col justify-center items-center font-medium text-xxs divide-y divide-gray-300 text-gray-800">
                            <div id="abremodal" data-target="modal-subseccion" data-toggle="modal" class="p-2 w-full rounded-sm cursor-pointer hover:bg-gray-100 flex flex-row justify-between items-center">
                                <h1 class="truncate mr-2">CALIDAD</h1>
                                <div class=" bg-red-400 text-red-700 text-xxs h-5 w-5 rounded-md font-bold flex flex-row justify-center items-center">
                                    <h1>22</h1>
                                </div>
                            </div>
                            <div class="p-2 w-full rounded-sm cursor-pointer hover:bg-gray-100 flex flex-row justify-between items-center">
            ...
            <div class="p-2 mt-6 flex justify-center items-center flex-col">
                <div class="flex flex-row items-center w-full">
                    <div class="ml-10 relative text-gray-600 w-2/6 self-start">
                        <input class="border-2 border-gray-300 bg-white h-8 px-5 pr-16 rounded-md text-sm focus:outline-none w-full" type="search" name="search" placeholder="Buscar Equipo/Local">
                ...
                <div class="mt-2 w-full flex flex-col justify-center items-center">
                    ...
                    <div id="equipo123toggle" class="hidden w-full mb-2">
                        <!-- equipo de despiece -->
                        <div class="mt-1 w-full flex flex-row justify-center items-center font-semibold text-xs h-8 text-bluegray-500 cursor-pointer border-gray-600">
                            <div class="w-2/6 h-full flex flex-row items-center justify-between">
                                <div class="ml-3 flex flex-row items-center truncate bg-gray-200 h-full w-full rounded-l-md hover:shadow-md">
                        ...
                        <div class="mt-1 w-full flex flex-row justify-center items-center font-semibold text-xs h-8 text-bluegray-500 cursor-pointer border-gray-600">
                            ...
                            <!-- MC PENDIENTES -->
                            <div class="w-16 h-full flex items-center justify-center bg-red-200 text-red-400 hover:shadow-md">
                                <h1>22</h1>
                            </div>
                            <!-- MC SOLUCIONADOS -->
                    ...
                    <!-- local -->
                    <div class="mt-2 w-full flex flex-row justify-center items-center font-semibold text-xs h-8 text-bluegray-500 cursor-pointer">
                        <div id="local123" onclick="expandir(this.id)" class="w-2/6 h-full flex flex-row items-center justify-between bg-purple-100 text-purple-500 rounded-l-md cursor-pointer hover:shadow-md">
                            <div class=" flex flex-row items-center truncate">
    ...
    <div id="modal-zia" class="modal">
        <div class="modal-window rounded-md pt-10 w-11/12 rounded-md">
            ...
            <div class="flex flex-row-items-center justify-center">
                <div class="absolute top-0 right-0">
                    <button onclick="cerrarmodal('modal-zia')" class="cursor-pointer text-md  text-red-500  bg-red-200 px-2 rounded-bl-md rounded-tr-md font-normal">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
            ...
            <div class="flex flex-col justify-center items-center mt-10 w-full divide-y divide-gray-200">
                ...
                <div class="flex flex-row justify-center items-center w-full py-4">
                    ...
                    <!-- Contenedor de las 4 columnas -->
                    <div class="flex flex-wrap justify-center items-center w-full text-gray-800 text-center font-semibold text-xs">
                        <!-- Contenedor de tareas -->
                        <div id="filtrospen" ondblclick="expandirpapa(this.id)" class="w-1/4 h-40 overflow-y-auto scrollbar px-2 rounded-md">
                            <!-- COLUMNA PENDIENTES -->
                            <!-- Contenedor de tarea -->
                            <div id="567" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                                ...
                                <div class="flex flex-row justify-between items-center text-sm">
                                    <div class="flex flex-row">
                                        <img src="https://ui-avatars.com/api/?format=svg&rounded=true&size=300&background=2d3748&color=edf2f7&name=Eduardo%20Meneses" width="20" height="20" alt="">
                                ...
                                <div id="567toggle" class="hidden mt-2">
                                    <div class="flex flex-col flex-wrap text-justify p-2 bg-white rounded-md font-normal">
                                        ...
                                        <div class="flex flex-row mt-1 self-center">
                                            <img src="https://ui-avatars.com/api/?format=svg&rounded=true&size=300&background=2d3748&color=edf2f7&name=J%20D" width="20" height="20" alt="">
                                    ...
                                    <button class="py-1 px-2 my-2 rounded-md bg-red-200 text-red-500 hover:shadow-sm w-full font-semibold">
                                        <i class="fas fa-eye mr-1  text-sm"></i>Ver en Planner
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div id="filtrodep" ondblclick="expandirpapa(this.id)" class="w-1/4 h-40 overflow-y-auto scrollbar px-2">
                            <!-- COLUMNA DEP -->
                            <!-- Contenedor de tarea -->
                            <div id="123" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="456" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="678" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                                ...
                                <div class="flex flex-row justify-between items-center text-sm">
                                    ...
                                    <div class="flex flex-row items-center text-gray-600">
                                        <i class="fas fa-paperclip mr-2"></i>
                                        <i class="fas fa-comment-dots mr-2"></i>
                                        <p class="text-xs font-normal bg-purple-200 text-purple-500 py-1 px-2 rounded-full">
                                            Dirección</p>
                                    </div>
                                </div>
                                <!-- Toogle -->
                        ...
                        <div id="filtrotra" ondblclick="expandirpapa(this.id)" class="w-1/4 h-40 overflow-y-auto scrollbar px-2">
                            <!-- COLUMNA TRABAJANDO -->
                            <!-- Contenedor de tarea -->
                            <div id="980" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                        ...
                        <div id="filtrossol" ondblclick="expandirpapa(this.id)" class="w-1/4 h-40 overflow-y-auto scrollbar px-2">
                            <!-- COLUMNA SOLUCIONADOS -->
                            <!-- Contenedor de tarea -->
                            <div id="111" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="222" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="333" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="444" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="555" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="666" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                            ...
                            <!-- Contenedor de tarea -->
                            <div id="777" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
                                <div class="my-1">
                ...
                <div class="flex flex-row justify-center items-center w-full py-4">
                    ...
                    <div class="flex flex-wrap justify-center items-center w-full text-gray-800 text-center font-semibold text-xs">
                        ...
                        <div id="filtrossol" ondblclick="expandirpapa(this.id)" class="w-1/4 h-40 overflow-y-auto scrollbar px-2 relative">
                            <!-- COLUMNA SOLUCIONADOS -->
                            <!-- Contenedor de tarea -->
                            <div id="111" onclick="expandir(this.id)" class="flex flex-col w-full my-2 px-3 py-1 rounded-md cursor-pointer bg-gray-200 text-gray-800 text-left font-medium hover:shadow-md">
                                <!-- Titulo -->
    ...
    <div id="modal-responsable" class="modal">
        <div class="modal-window rounded-md pt-10" style="width: 370px;">
            <!-- BOTON CERRARL -->
            <div class="absolute top-0 right-0">
                <button onclick="cerrarmodal('modal-responsable')" class="cursor-pointer text-md  text-red-500  bg-red-200 px-2 rounded-bl-md rounded-tr-md font-normal">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <!-- INDICACION -->
            ...
            <div class="p-2 flex flex-col justify-center items-center flex-col w-full pb-6">
                <div class="mb-3 w-full">
                    <input class="border border-gray-200 shadow-md bg-white h-10 px-2 rounded-md text-sm focus:outline-none w-full" type="search" name="search" placeholder="Buscar...">
                </div>

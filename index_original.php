    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <!--HERO BAR-->
                <section id="sectionHeroMain" class="hero is-light is-small is-dark mt-5">
                            ...
                            <div id="navbarMenuHeroA" class="navbar-menu">
                                <div class="navbar-start">
                                    <span class="navbar-item">
                                        <img src="svg/planner2020.svg" width="30px" alt="">
                                    </span>
                                    <span class="navbar-item">
                                        <p class="subtitle is-3">Planner</p>
                                    </span>
                ...
                <section id="sectionHeroListaEquipos" class="hero is-light is-small mt-5" style="display:none;">
                        ...
                        <div class="">
                            <div id="navbarMenuHeroA" class="navbar-menu">
                                <div class="navbar-start">
                                    ...
                                    <div id="divNameSeccion" class="navbar-item zic-background">
                                        <p class="seccion-logo zic-background">ZIC</p>
                                    </div>
                                    <span class="navbar-item">
                                ...
                                <div class="hero-head">
                                    <nav class="navbar">
                                        <div class="navbar-start has-text-centered">
                                            <div class="navbar-item zic-background">
...
//                                                        echo "<option value=\"$idUser\">$nombreEmpleado $apellidoEmpleado</option>";
                            ...
                            <div class="level">
                                <div class="media-content">
                                    <input id="txtFechaRealizacion" type='text' 
                                           class='input has-text-centered datepicker-here' 
                                           data-language='es' data-auto-close="true" data-date-format="mm/dd/yyyy"
        ...
        <div id="modal-equipo-info" class="modal">
            ...
            <div class="modal-card modal-md">
                ...
                <section class="modal-card-body">
                    ...
                    <div id="rowEditarInfo" class="columns" style="display: none;">
    ...
    <script src="js/plannerJS.js?v4.0.3"></script>
...
Class Secciones {
    ...
    public function mostrarCols($idUsuario, $idSeccionTarea, $fotoSeccion) {
        ...
        $query = "SELECT seccion, titulo_seccion, "
                . "url_image, url_video "
                . "FROM c_secciones "
                . "WHERE id = $idSeccionTarea";
        try {
            $resp = $conn->obtDatos($query);
            if ($conn->filasConsultadas > 0) {
                foreach ($resp as $dts) {
        ...
        if ($idDestino == 10) {
            $query = "SELECT status FROM t_mc "
                    . "WHERE fecha_creacion >= '$fecAnterior' "
                    . "AND id_seccion = $idSeccionTarea "
                    . "AND activo = 1";
        } else {
            $query = "SELECT status FROM t_mc "
        ...
        if ($idDestino == 10) {
            $query = "SELECT id FROM c_rel_destino_seccion "
                    . "WHERE id_seccion = $idSeccionTarea";
        } else {
            $query = "SELECT id FROM c_rel_destino_seccion "
                    . "WHERE id_destino = $idDestino "
        ...
        try {
            ...
            if ($conn->filasConsultadas > 0) {
                foreach ($resp as $dts) {
                    ...
                    $query = "SELECT id, id_subseccion "
                            . "FROM c_rel_seccion_subseccion "
                            . "WHERE id_rel_seccion = $idRelDestSecc";
                    try {
                        ...
                        if ($conn->filasConsultadas > 0) {
                            foreach ($rels as $d) {
                                ...
                                $query = "SELECT grupo FROM c_subsecciones "
                    ...
                    if (count($lstSecciones) > 0 && count($aux) > 0) {
                        ...
                        foreach ($lstSecciones as $subseccion) {
                            ...
                            $query = "SELECT id, grupo "
                                    . "FROM c_subsecciones "
                                    . "WHERE id = " . $subseccion['idSubseccion'] . "";
                            try {
...
//                                $salida .= "</div>";
                            ...
                            //******** RESTO DE LAS SECCIONES **********
                                ...
                                if ($idSubseccion == 12 || $idSubseccion == 342 || $idSubseccion == 343 || $idSubseccion == 344) {
									...
									//cambio de colores modifiacion 2020
...
//                </div>";
    ...
    public function mostrarCols_2($idUsuario, $idSeccionTarea, $fotoSeccion) {
        $salida = "";
        $lstSecciones = [];
        if (isset($_SESSION['idDestino'])) {
            $idDestino = $_SESSION['idDestino'];
...
//                                            }
                                        ...
                                        elseif ($nombreCategoria == "BITACORAS" || $nombreCategoria == "STOCK - PEDIDOS" || $nombreCategoria == "INFORMACION") {
                                            ...
                                            if ($idDestino == 10) {
                                                $query = "SELECT id FROM t_mc "
                                                        . "WHERE id_subseccion = $idSubseccion "
                                                        . "AND id_categoria = $idCategoria AND activo = 1 AND status = 'N'";
                                            } else {
                                                $query = "SELECT id FROM t_mc "
                                                        . "WHERE id_destino = $idDestino "
                                                        . "AND id_subseccion = $idSubseccion "

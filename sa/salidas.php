                    ...
                    <div class="container">
                        ...
                        <div class="columns">
                            <div class="column has-text-right">
                                <button class="button is-primary" onclick="agregarCarritoSalida();"><span class="icon"><i class="fa fa-cart-arrow-down"></i></span><span>Agregar</span></button>
                            </div>
                        </div>
                    </div>
                </header>
                <section class="modal-card-body">
                    <div class="columns is-centered">
                        <div id="listItems" class="column is-11">
                            <table id="tablaItems" class="table is-fullwidth" style="width:100%;">
                                <thead>
                                    <tr>
                                        <th>Item</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($listaItems as $item) {
                                        ...
                                        echo "<td><input id=\"txtCantidadMaterial_$item->id " . "_$item->cantidad\" type=\"number\" class=\"input is-small\"></td>"
                                        . "</tr>";
...
////                                . "</div>"
//                                        . "</div>";
////                                echo "<h6 class=\"title is-6 manita border rounded py-1 px-1 my-1 mx-2 text-truncate usuario\">"
////                                . "" . $item->descripcion . " "
////                                . "" . $item->caracteristicas . " "
////                                . "" . $item->cantidad . ""
////                                . "</h6>";
                            ...
                            <div class="container">
                                ...
                                <div class="columns">
                                    <div class="column has-text-centered">
                                        ...
                                        if(isset($_GET['tipo'])){
                                            ?>
                                        <button id="" class="button is-primary is-fullwidth is-block" onclick="registrarSalidaMaterialZI('<?php echo $codigoSA; ?>', <?php echo $idSubalmacen; ?>, '<?php echo $tipo; ?>', '<?php echo $motivo; ?>')">ACEPTAR</button>
                                        <?php
                                        }else{
                                            ?>
                                        <button id="" class="button is-primary is-fullwidth is-block" onclick="registrarSalidaMaterial('<?php echo $codigoSA; ?>', <?php echo $idSubalmacen; ?>, <?php echo $codigoGift; ?>)">ACEPTAR</button>
                                            <?php
                                        }
                                        ?>

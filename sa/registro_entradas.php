        ...
        <section class="hero is-fullheight">
            <div class="hero-body">
                <div class="container">
                    ...
                    <div class="columns is-centered is-mobile">
                        <div class="column is-6 has-text-centered">
                            <h1 class="title is-size-5">REGISTROS DE ENTRADA DE MATERIAL</h1>
                        </div>
                    </div>
                    <div class="columns">
                        <div class="column">
                            <div class="table-container">
                                <table id="tableEntradas" class="table" style="width:100%">
                                    ...
                                    <tbody class="is-size-7">
                                        ...
                                        $conn->conectar();
                                        $query = "SELECT "
                                                . "t_subalmacenes_entradas.id_usuario 'IDUSUARIO', "
                                                . "t_subalmacenes_entradas.id_material 'IDMATERIAL', "
                                                . "t_subalmacenes_entradas.cantidad 'CANTIDAD', "
                                                . "t_subalmacenes_entradas.fecha 'FECHA', "
                                                ...
                                                . "FROM t_subalmacenes_entradas "
                                                . "INNER JOIN t_colaboradores ON t_subalmacenes_entradas.id_usuario = t_colaboradores.codigo_sa "
                                                . "INNER JOIN t_subalmacenes_items ON t_subalmacenes_entradas.id_material = t_subalmacenes_items.id "

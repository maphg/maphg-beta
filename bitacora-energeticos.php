...
<html lang="es">
    ...
    <body class="bg-gray-300" style="font-family: 'Manrope', sans-serif;">
                                ...
                                <div class="container mx-auto px-4 py-2 md:py-10">
                                    <div class="mb-5 w-64">
                                        <div class="relative">
                                            ...
                                            <div class="z-30 bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0"
                                                ...
                                                <div class="flex flex-wrap -mx-1"
                                                    ...
                                                    <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                                                        <div style="width: 14.28%" class="px-1 mb-1">
                                                            <div @click="getDateValue(date); llamarFuncion('consumoDia');"
                                                                x-text="date"
            ...
            <div class="w-full flex flex-col items-center flex-wrap">
                <div class="cursor-pointer flex self-start my-3">
                    ...
                    <h1 class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                        <span><i class="fad fa-circle text-sm text-blue-400 mr-1"></i></span>Consumo del dia</h1>
                </div>
                <div class="flex flex-row flex-wrap justify-center items-center w-full">
                    ...
                    <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                        <div
                            class="w-56 h-56 bg-white shadow-md rounded-md flex flex-col items-center justify-center leading-none relative">
                            ...
                            <h1 class=" font-semibold text-yellow-600 bg-yellow-200 py-1 px-3 mt-3 rounded-full">
                                Eléctricidad</h1>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                        <div
                            ...
                            <h1 class="text-gray-600 font-medium text-base">litros</h1>
                            <h1 class=" font-semibold text-orange-400 bg-orange-200 py-1 px-3 mt-3 rounded-full">Diesel
                            </h1>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                        <div
                            ...
                            <h1 id="dataOcupacion" class="text-gray-700 font-bold text-2xl ">66<span
                                    class="text-2xl text-gray-500">%</span></h1>
                            <h1 class="text-gray-600 font-medium text-base">Porcentaje</h1>
                            <h1 class=" font-semibold text-gray-600 bg-gray-200 py-1 px-3 mt-3 rounded-full">Ocupación
                            </h1>
                        </div>
                    </div>
                ...
                <div class="cursor-pointer flex self-start my-3"
                    onclick="modalTailwind('modal-acontecimientos','toggle');">
                    <!-- CONTENEDOR DE TITULO -->
                    <h1 class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                        <span><i class="fad fa-circle text-sm text-red-400 mr-1"></i></span>Acontecimientos del dia</h1>
                </div>
                <!-- acontecimientos -->
                <div class="flex flex-row items-center justify-evenly w-full mb-3 overflow-x-auto">
                    <div class="sm:w-full md:w-1/4 mx-3 h-auto bg-white shadow-md rounded-md p-2">
                        <div class="flex flex-col items-center justify-center">
                            <h1 class=" font-semibold text-yellow-600 bg-yellow-200 py-1 px-3 my-2 rounded-full">
                                Electricidad</h1>
                        </div>
                    ...
                    <div class="sm:w-full md:w-1/4 mx-3 h-auto bg-white shadow-md rounded-md p-2">
                        <div class="flex flex-col items-center justify-center">
                            <h1 class=" font-semibold text-orange-400 bg-orange-200 py-1 px-3 my-2 rounded-full">Diesel
                            </h1>
                        </div>
                        <!-- items de acontecimientos -->
                ...
                <div class="cursor-pointer flex self-start my-3">
                    <!-- CONTENEDOR DE TITULO -->
                    <h1 class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                        <span><i class="fad fa-circle text-sm text-green-400 mr-1"></i></span>Ultima semana</h1>
                </div>
                ...
                <div class="flex flex-row items-start justify-evenly w-full mb-3 overflow-x-auto">
                    <div class="sm:w-5/6 md:w-1/4 mx-3 h-auto bg-white shadow-md rounded-md p-2">
                        ...
                        <p class="truncate font-bold text-gray-600 text-base text-center my-1">Acontecimientos de la
                            semana</p>
        ...
        <div id="modal-acontecimientos"
            class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center hidden">
            <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"
                onclick="modalTailwind('modal-acontecimientos','toggle');"></div>

            <div
                class="modal-window w-full md:w-2/5 rounded-lg flex flex-col items-center justify-center bg-white z-50 p-6">
                ...
                <form class="w-full" autocomplete="off">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/3 px-3">
                            ...
                            <input id="acontecimientosTitulo"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="Título">
                        </div>
                        <div class="w-full md:w-1/3 px-3">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                for="grid-last-name">
                            ...
                            <input id="acontecimientosDescripcion"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="Descripción"
                                onkeyup="if(event.keyCode == 13) llamarFuncion('agregarAcontecimiento')">
                        </div>
                        <div class="w-full md:w-1/3 px-3 pt-6">
                            <select id="acontecimientosEnergetico"
                                class="block appearance-none w-full bg-white border border-grey-light hover:border-grey px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline font-black text-gray-700"
                                onclick="llamarFuncion('consultaAcontecimientos');">

...
function obtenerEquiposxPalabra(
  ...
  $.ajax({
    ...
    url: "php/plannerPHP.php",
    data:
      "action=buscarPorPalabra&idGrupo=" +
      idGrupo +
      "&idDestino=" +
      idDestino +
      "&idCategoria=" +
...
function agregarComentarioEquipo(idEquipo) {
  ...
  $.ajax({
    ...
    url: "php/plannerPHP.php",
    data:
      "action=insertarComentarioEquipo&idEquipo=" +
      idEquipo +
      "&comentario=" +
      comentario,
    success: function (data) {
...
function actualizarInfoEquipo(idEquipo) {
  ...
  $.ajax({
    ...
    url: "php/plannerPHP.php",
    data:
      "action=actualizarInfoEq&idEquipo=" +
      idEquipo +
      "&marca=" +
      marca +
      "&modelo=" +
...
function agregarComentarioMC(idMC) {
  ...
  $.ajax({
    ...
    url: "php/plannerPHP.php",
    data:
      "action=insertarComentarioMC&idMC=" + idMC + "&comentario=" + comentario,
    success: function (data) {
      if (data == 1) {
  ...
  if (event.keyCode == 13) {
    if (comentario != "") {
      $.ajax({
        ...
        url: url,
        data:
          "action=24&idProyecto=" + idProyecto + "&comentario=" + comentario,
  ...
  if (event.keyCode == 13) {
    if (comentario != "") {
      $.ajax({
        ...
        url: url,
        data:
          "action=24&idActividad=" + idActividad + "&comentario=" + comentario,

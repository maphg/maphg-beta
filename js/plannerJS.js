...
function mostrarColumnasSeccion(idPermiso, idUsuario) {
    ...
    $.ajax({
        ...
        data: "action=2&idSeccion=" + selected + "&idUsuario=" + idUsuario + '&idPermiso=' + idPermiso + '&tipo=' + tipo,
...
function obtenerEquipos(idGrupo, idDestino, idCategoria, idSubcategoria, idRelCatSubcat, pagina, destino, seccion, subseccion) {
    ...
    $("#busqueda").val("");
    $("#btnBuscar").attr("onclick", "obtenerEquiposxPalabra(" + idGrupo + "," + idDestino + "," + idCategoria + "," + idSubcategoria + "," + idRelCatSubcat + "," + pagina + ")");
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=3&idGrupo=' + idGrupo
            + '&idDestino=' + idDestino
            + '&idCategoria=' + idCategoria
            + '&idSubcategoria=' + idSubcategoria
            + '&idRelCatSubcat=' + idRelCatSubcat
            + '&pagina=' + pagina,
        beforeSend: function () {
        ...
        success: function (data) {
            ...
            try {
                ...
                $("#link-auditorias").attr("href", "file-explorer.php?p=" + destino + "/AUDITORIAS/" + seccion + "/" + subseccion);
                $("#link-certificaciones").attr("href", "file-explorer.php?p=" + destino + "/CERTIFICACIONES - NORMATIVAS/" + seccion + "/" + subseccion);
                $("#link-cotizaciones").attr("href", "file-explorer.php?p=" + destino + "/COTIZACIONES -  FACTURAS/" + seccion + "/" + subseccion);
                $("#link-planos").attr("href", "file-explorer.php?p=" + destino + "/PLANOS/" + seccion + "/" + subseccion);
                $("#link-otros").attr("href", "file-explorer.php?p=" + destino + "/OTROS/" + seccion + "/" + subseccion);
                $("#divNameSeccion").html("<p class=\"seccion-logo\">" + seccion + "</p>");
...
function obtenerEquiposxPagina(idGrupo, idDestino, idCategoria, idSubcategoria, idRelCatSubcat, pagina) {
    //$("#hddIdEquipo").val(idEquipo);
    $("#hddIdDestino").val(idDestino);
    $("#hddIdSubseccion").val(idGrupo);
    $("#hddIdCategoria").val(idCategoria);
...
function obtenerEquiposxPalabra(idGrupo, idDestino, idCategoria, idSubcategoria, idRelCatSubcat, pagina) {
    //    $("#txtBuscarEquipo").val("");
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=buscarPorPalabra&idGrupo=' + idGrupo
            + '&idDestino=' + idDestino
            + '&idCategoria=' + idCategoria
            + '&idSubcategoria=' + idSubcategoria
            + '&idRelCatSubcat=' + idRelCatSubcat
...
//OBTENER LA LISTA DE EQUIPOS DE LA SUBSECCION POR PAGINA
function obtenerEquiposxPaginaxPalabra(idGrupo, idDestino, idCategoria, idSubcategoria, idRelCatSubcat, pagina) {
    var palabra = $("#busqueda").val();
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
...
function buscarEquipo(element, idDestino, idGrupo, idCategoria, idSubcategoria) {
    var equipo = element.value;
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=21&equipo=' + equipo + '&idDestino=' + idDestino + '&idSubseccion=' + idGrupo + '&idCategoria=' + idCategoria + '&idSubcategoria=' + idSubcategoria,
        success: function (data) {
...
function agregarComentarioEquipo(idEquipo) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=insertarComentarioEquipo&idEquipo=' + idEquipo + '&comentario=' + comentario,
        success: function (data) {
            if (data == 1) {
...
function actualizarInfoEquipo(idEquipo) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=actualizarInfoEq&idEquipo=' + idEquipo + '&marca=' + marca + '&modelo=' + modelo
...
function obtDetalleSubcategoria(idGrupo, idDestino, idCategoria, idSubcategoria, idRelSubcategoria) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=4&idSubseccion=' + idGrupo + '&idDestino=' + idDestino + '&idCategoria='
        ...
        success: function (data) {
            try {
                ...
                $("#txtTarea").attr("onkeypress", "agregarTarea(" + idEquipo + ", " + idGrupo + ", " + idDestino + ", " + idSubcategoria + ", " + idCategoria + ")");
                $("#hddIdEquipo").val(idEquipo);
                $("#hddIdDestino").val(idDestino);
                $("#hddIdSubseccion").val(idGrupo);
                $("#hddIdCategoria").val(idCategoria);
...
function obtCorrectivosG(idGrupo, idDestino, idCategoria, idSubcategoria, idRelSubcategoria, status) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=obtMCG&idSubseccion=' + idGrupo + '&idDestino=' + idDestino + '&idCategoria='
            + idCategoria + '&idSubcategoria=' + idSubcategoria + '&idRelSubcategoria=' + idRelSubcategoria + '&status=' + status,
        success: function (data) {
            try {
                var datos = JSON.parse(data);
                $("#colMC").html("");
...
function obtDetalleTarea(idTarea) {
    $("#txtComentario").attr('onkeypress', 'insertarComentario(' + idTarea + ', this);');
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#btnActualizarTarea").attr("onclick", "actualizarTarea(" + idTarea + ")");
...
function verPenSubcategorias(element, idDestino, idSubseccion, idCategoria, idSubcategoria) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=5&idDestino=' + idDestino + '&idSubseccion=' + idSubseccion + '&idCategoria=' + idCategoria + '&idSubcategoria=' + idSubcategoria + '&status=' + status,
        success: function (data) {
...
function recargarListaTareas(idGrupo, idDestino, idCategoria, idSubcategoria) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=5&idDestino=' + idDestino + '&idSubseccion=' + idGrupo + '&idCategoria=' + idCategoria + '&idSubcategoria=' + idSubcategoria + '&status=' + status,
        success: function (data) {
            $("#divListaTareas").html(data);
        }
    });
...
function finalizarTarea(idActividad, chkb, idUsuario) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=12&idActividad=' + idActividad + '&status=F&completo=' + idUsuario,
        success: function (data) {
            if (data == 1) {
                if (idEquipo != 0) {
                    //recargarListaTareasMC(idEquipo)
...
function agregarTarea(idEquipo) {
    ...
    if (actividad != "") {
        $.ajax({
            type: 'post',
            url: 'php/plannerPHP.php',
            data: 'action=13&idEquipo=' + idEquipo + '&actividad=' + actividad
                + '&idGrupo=' + idSubseccion + '&idDestino=' + idDestino + '&idCategoria=' + idCategoria + '&idSubcategoria=' + idSubcategoria,
            success: function (data) {
                if (data == 1) {
                    if (idEquipo != 0) {
                        obtCorrectivos(idEquipo, 'N')
...
function obtDetalleEquipo(idEquipo, idGrupo, idDestino, idCategoria, idSubcategoria) {
    $.ajax({
        ...
        success: function (data) {
            try {
                var detalleEquipo = JSON.parse(data);
                $("#btnPendientesMC").attr("onclick", "verPenSolMC(this, " + idEquipo + ")");
                $("#btnSolucionadosMC").attr("onclick", "verPenSolMC(this, " + idEquipo + ")");
                $("#txtArchivoEquipo").attr("onchange", "cargar_archivos_eq()");
                $("#txtTareaMC").attr("onkeypress", "agregarTarea(" + idEquipo + ", " + idGrupo + ", " + idDestino + ", " + idSubcategoria + ", " + idCategoria + ")");
...
function obtPreventivos(idEquipo, idGrupo, idDestino, idCategoria, idSubcategoria) {
    $("#hddIdEquipo").val(idEquipo);
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
...
function obtDetalleTareaMC(idTarea) {
    $("#txtComentarioMC").attr('onkeypress', 'insertarComentario(' + idTarea + ', this);');
    $("#txtArchivoMC").attr('onchange', 'cargar_archivos_mc_eq(' + idTarea + ');')
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=6&idTarea=' + idTarea,
        success: function (data) {
            ...
            $("#txtEditTituloTarea").val(datos.actividad);
            $("#btnActualizarTarea").attr("onclick", "actualizarTareaMC(" + idTarea + ")");
            var chkb = document.getElementById("chkbEliminarTarea");
            chkb.checked = false;
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data == 1) {
                ...
                actualizarTimeLine(idTarea);
                recargarListaTareasMC(idSubseccion, idDestino, idCategoria, idSubcategoria);
            }
...
function verDetalleMP(idPlan, semana, nombreplan, idPlaneacion, tipoplan) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#btnGenerarOT").attr("onclick", "generarOrdenTrabajo(" + idPlan + ", " + idPlaneacion + ",'', '" + tipoplan + "')")
            $("#ulActividades").html(data);
            $("#hddidPlanMP").val(idPlan);
            $("#hddidPlaneacion").val(idPlaneacion);

            $("#btnImprimirOT").attr("onclick", "window.open('planner/orden-trabajo.php?idEquipo=" + idEquipo + "&idPlanMP=" + idPlan + "&idPlaneacion=" + idPlaneacion + ")");
        }
    });
...
function mostrarDetalleOT(idPlaneacion, idEquipo, tipoplan) {
    ...
    $.ajax({
        ...
        success: function (data) {
            try {
                var datos = JSON.parse(data);
                $("#btnImprimirOT").attr("onclick", "imprimirOT(" + idEquipo + ", " + datos.id + ")");
                $("#btnFinalizarOT").attr("onclick", "marcarOTRealizada(" + datos.id + ", '" + tipoplan + "')");
                $("#txtComentarioOT").attr('onkeypress', 'insertarComentarioOT(this, ' + datos.id + ');');
                $("#txtArchivoOT").attr('onchange', 'cargar_archivos_ot(' + datos.id + ');');
...
function obtDetalleProyecto(idProyecto, idDestino, idSeccion, idSubseccion) {
    ...
    try {
        $.ajax({
            type: 'post',
            url: 'php/plannerPHP.php',
            data: 'action=22&idProyecto=' + idProyecto + '&idDestino=' + idDestino + '&idSeccion=' + idSeccion + '&idSubseccion=' + idSubseccion,
            success: function (data) {
                try {
                    var detalleProyecto = JSON.parse(data);
                    $("#btnPendientesPAProyecto").attr("onclick", "verPendSolProyecto(this, " + idProyecto + ")");
                    $("#btnSolucionadosPAProyecto").attr("onclick", "verPendSolProyecto(this, " + idProyecto + ")");
                    $("#txtActividadPA").attr("onkeypress", "agregarActividadMCProyecto(" + idProyecto + ", " + idDestino + ", " + idSeccion + ", " + idSubseccion + ")");

                    $("#txtCotProyecto").attr("onchange", "upload_cots_proyecto(" + idProyecto + ", " + idDestino + ", " + idSeccion + ", " + idSubseccion + ")");
                    $("#txtJustificacionProyecto").attr("onchange", "upload_just_proyecto(" + idProyecto + ", " + idDestino + ", " + idSeccion + ", " + idSubseccion + ")");
                    $("#txtTituloProyecto").attr("onkeypress", "actualizarDatosProyecto(" + idProyecto + ")");
                    $("#txtJustificacion").attr("onkeypress", "actualizarDatosProyecto(" + idProyecto + ")");
                    $("#txtAñoProyecto").attr("onkeypress", "actualizarDatosProyecto(" + idProyecto + ")");
                    $("#txtCosteProyecto").attr("onkeypress", "actualizarDatosProyecto(" + idProyecto + ")");
                    $("#cbTipoProyecto").attr("onchange", "cambiarTipo(" + idProyecto + ")");
                    ...
                    $("#timeLineJustificacionesProyecto").html(detalleProyecto.justificaciones);
...
function agregarActividadMCProyecto(idProyecto, idDestino, idSeccion, idSubseccion) {
    if (event.keyCode == 13) {
...
function agregarComentariosProy(idProyecto, idDestino, idSeccion, idSubseccion) {
    var url = 'php/plannerPHP.php';
...
function verComentariosActividad(idActividad, element) {
    ...
    $.ajax({
        ...
        success: function (data) {
            try {
                $(".titulo-actividad").removeClass("has-text-danger has-text-weight-bold");
                $("#" + spanActividad + "").addClass("has-text-danger has-text-weight-bold");

                $("#txtComentarioProyecto").attr("onkeypress", "agregarComentariosActividad(" + idActividad + ", " + element.id + ")");
...
function actualizarDatosProyecto(idProyecto) {
    if (event.keyCode == 13) {
        ...
        $.ajax({
            type: 'post',
            url: 'php/plannerPHP.php',
            data: 'action=26&idProyecto=' + idProyecto + '&titulo=' + titulo + '&justificacion=' + justificacion + '&año=' + año + '&coste=' + coste,
            success: function (data) {
                if (data == 1) {
                    toastr.success('', 'Correcto', {
                        "closeButton": true,
...
function buscarUsuarioProy(element, idDestino) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=10&idDestino=' + idDestino + '&palabra=' + palabra + '&proyecto=SI',
        success: function (data) {
...
function completarTareaProyecto(idActividad, element, idUsuario) {
    ...
    //    $("#modal-completar-tarea").modal('show');
    $("#btnFinalizarTareaProy").attr("onclick", "finalizarTareaProy(" + idActividad + "," + chkb + "," + idUsuario + ")");
    $("#btnCancelarFinalizarTareaProy").attr("onclick", "cancelarCompletarTareaProy(" + idCheckbox + "); closeModal('modalConfirmacionTareaProy');");
}
...
function finalizarTareaProy(idActividad, chkb, idUsuario) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/plannerPHP.php',
        data: 'action=29&idActividad=' + idActividad + '&status=' + status + '&completo=' + idUsuario,
        success: function (data) {
            if (data == 1) {
                obtDetalleProyecto(idProyecto, idDestino, idSeccion, idSubseccion);
...
function completarProyecto(element) {
    ...
    //    $("#modal-completar-tarea").modal('show');
    $("#btnFinalizarProy").attr("onclick", "finalizarProyecto(" + idProyecto + "," + chkb + ")");
    $("#btnCancelarFinalizarProy").attr("onclick", "cancelarCompletarProy(" + idCheckbox + "); closeModal('modalFinalizarProyecto');");
}
...
function quitarTareaProyecto(idActividad) {
    ...
    $("#btnEliminarTareaProy").attr("onclick", "eliminarTareaProy(" + idActividad + ")");
}
...
function quitarAdjuntoProyecto(idAdjunto, tipo) {
    ...
    $("#btnEliminarArchivoProy").attr("onclick", "eliminarAdjuntoProy(" + idAdjunto + ", '" + tipo + "')");
}
...
function buscarMC() {
    ...
    if (fechaI != "" && fechaF != "") {
        $.ajax({
            type: 'post',
            url: 'php/plannerPHP.php',
            data: 'action=36&idSeccion=' + idSeccion + '&idSubseccion=' + idSubseccion + '&idEquipo=' + idEquipo + '&fechaI=' + fechaI + '&fechaF=' + fechaF
                + '&estado=' + estado,
            beforeSend: function () {
                var pageloader = document.getElementById("loader");
                if (pageloader) {
...
function buscarMP() {
    ...
    if (fechaI != "" && fechaF != "") {
        $.ajax({
            type: 'post',
            url: 'php/plannerPHP.php',
            data: 'action=38&idSeccion=' + idSeccion + '&idSubseccion=' + idSubseccion + '&idEquipo=' + idEquipo + '&fechaI=' + fechaI + '&fechaF=' + fechaF + '&estatus=' + estado,
            success: function (data) {
...
function buscarMisPendientes(idResponsable) {
    ...
    if (fechaI != "" && fechaF != "") {
        $.ajax({
            type: 'post',
            url: 'php/plannerPHP.php',
            data: 'action=39&idSeccion=' + idSeccion + '&idSubseccion=' + idSubseccion + '&idEquipo=' + idEquipo + '&fechaI=' + fechaI + '&fechaF=' + fechaF
                + '&estado=' + estado + '&idResponsable=' + idResponsable,
            beforeSend: function () {
                var pageloader = document.getElementById("loader");
                if (pageloader) {
                    pageloader.classList.toggle('is-active');
...
function mostrarMapa(destino, seccion, subseccion) {
    ...
    imagen = "<figure class='image'>" +
        "<a class='example-image-link' href='repositorio/maphg/" + destino + "/PLANOS/" + seccion + "/" + subseccion + "/mapa.png' data-lightbox='mapas-areas' data-title=''>" +
        "<img class='example-image img-fluid' src='repositorio/maphg/" + destino + "/PLANOS/" + seccion + "/" + subseccion + "/mapa.png' alt=''/>" +
        "</a>" +
        "</figure>";
...
function listarProyectos(idUsuario, id_Destino, id_Seccion, idSubseccion) {
    ...
    $.ajax({
        type: 'post',
        url: 'php/crud.php',
        data: { action: action, id_Destino: id_Destino, id_Seccion: id_Seccion, idSubseccion: idSubseccion, idUsuario: idUsuario },
...
function nuevoProyecto() {
    ...
    if (tituloProyecto != "") {
        $.ajax({
            type: "post",
            url: "php/crud.php",
            data: { action: action, tituloProyecto: tituloProyecto, id_DestinoProyecto: id_DestinoProyecto, id_SeccionProyecto: id_SeccionProyecto, id_UsuarioProyecto: id_UsuarioProyecto, idSubseccionProyecto: idSubseccionProyecto },
...
function modalJustificacion(idProyecto, idJustificacion) {
    ...
    $.ajax({
        type: "post",
        url: "php/crud.php",
        data: { action: action, idProyecto: idProyecto, idJustificacion: idJustificacion },
...
function actualizarJustificacionProyecto() {
    ...
    $.ajax({
        ...
        type: "post",
        url: "php/crud.php",
        data: { action: action, idProyecto: idProyecto, justificacion: justificacion },
...
function CapturarStatusGeneral(idUsuarioTG, idDestinoTG, idSeccionTG, idSubseccionTG, tablaTG) {
...
// Agregar
function datosStatusProyecto(idDestino, idSeccion, idSubseccion, idTabla, idPlanAccion, tabla) {
...
function aplicarStatus(statusProyecto) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                Swal.fire(
                    ...
                    guardarStatusProyectoPlanAccion(action, idDestino, idSeccion, idSubseccion, idTabla, idPlanAccion, tabla, statusProyecto)
                )
            }
        })
    } else {
    ...
    function guardarStatusProyectoPlanAccion(action, idDestino, idSeccion, idSubseccion, idTabla, idPlanAccion, tabla, statusProyecto) {
        $.ajax({
            type: "post",
            url: "php/crud.php",
            data: {

...
class Planner
{
    ...
    public function obtenerEquipos($idGrupo, $idDestino, $idCategoria, $idSubcategoria, $idRelCatSubcat, $pagina)
    {
        ...
        $listaEquipo->listaEquipos = "<div class=\"columns is-gapless my-1 is-mobile\">"
            ...
            . "<div class=\"column\"><p class=\"t-titulos\" data-tooltip=\"Mantto. Correctivo: Pendientes\"> FALLAS P</p></div>"
            . "<div class=\"column\"><p class=\"t-titulos\" data-tooltip=\"Mantto. Correctivo: Finalizados\"> FALLAS S</p></div>"
            ...
            . "<div class=\"column\"><p class=\"t-titulos\" data-tooltip=\"Mantto. TAREAS: P\">TAREAS P</p></div>"
            . "<div class=\"column\"><p class=\"t-titulos\" data-tooltip=\"Mantto. TAREAS: S\">TAREAS S</p></div>"
        ...
        if ($idDestino == 10) { //Buscar equipos de la seccion de todos los destinos
            if ($idCategoria == 1) { //Equipos MC/MP
                if ($idGrupo == 12000 || $idGrupo == 342 || $idGrupo == 343 || $idGrupo == 344) {
        ...
        if ($idDestino == 10) { //Buscar equipos de la seccion de todos los destinos
            if ($idCategoria == 1) { //Equipos MC/MP
                if ($idGrupo == 12000 || $idGrupo == 342 || $idGrupo == 343 || $idGrupo == 344) { //Subseccion Fan&Coils, Villas GP, TRS o Familiy
                    //Se obtiene el nombre de la subcategoria que seria el nombre del hotel
                    $query = "SELECT subcategoria "
                        . "FROM c_subcategorias_planner "
                        . "WHERE id = $idSubcategoria";
                ...
                try {
                    ...
                    if ($conn->filasConsultadas > 0) {
                        foreach ($equipos as $e) {
                            ...
                            // Obtiene Cantidad P y F de MPNP -> Tareas
                            ...
                            try {
                                $resp = $conn->obtDatos($query);
                                $mpnPlanificadoP = $conn->filasConsultadas;
                            } catch (Exception $ex) {
                                $listaEquipo = $ex;
                            }
                            ...
                            try {
                                $resp = $conn->obtDatos($query);
                                $mpnPlanificadoF = $conn->filasConsultadas;
                            } catch (Exception $ex) {
                                $listaEquipo = $ex;
                            }
                            ...
                            if ($mpnPlanificadoF > 0) {
                                $listaEquipo->listaEquipos .= "<div class=\"column\"><p class=\"t-solucionado\" onclick=\"obtTareasF($idEquipo,'$equipo');\">$mpnPlanificadoF</p></div>";
                            } else {
                                $listaEquipo->listaEquipos .= "<div class=\"column\"><p class=\"t-normal\" onclick=\"obtTareasF($idEquipo, '$equipo');\">$mpnPlanificadoF</p></div>";
                            }
                            // Fin Segmento. 
    ...
    public function obtenerEquiposxPalabra($idGrupo, $idDestino, $idCategoria, $idSubcategoria, $idRelCatSubcat, $pagina, $palabra)
    {
        ...
        if ($idDestino == 10) { //Buscar equipos de la seccion de todos los destinos
            if ($idCategoria == 1) { //Equipos MC/MP
                if ($idGrupo == 1200 || $idGrupo == 342 || $idGrupo == 343 || $idGrupo == 344) { //Subseccion Fan&Coils, Villas GP, TRS o Familiy
                    //Se obtiene el nombre de la subcategoria que seria el nombre del hotel
                    $query = "SELECT subcategoria "
                        . "FROM c_subcategorias_planner "
                        . "WHERE id = $idSubcategoria";
    ...
    public function obtCorrectivosG($idSubseccion, $idDestino, $idCategoria, $idSubcategoria, $idRelSubcategoria, $status)
    {
        ...
        $equipo->correctivos .= "</button>"
            ...
            . "<input id=\"txtTituloTareaMC\" class=\"input\" type=\"text\" placeholder=\"Agregar Falla\" autocomplete=\"off\">"
            . "</div>"
            . "<div class=\"control\">"
            ...
            . "<div class=\"column\">"
            . "<p class=\"t-titulos\" data-tooltip=\"Descripcion\"><strong>Descripcion de Falla</strong></p>"
            . "</div>"
            . "</div>"
            . "</div>"
            . "<div class=\"column is-white\">"

...
if (isset($_GET['action'])) {
    ...
    if ($action == "obtenerOTDigital") {
        ...
        WHERE t_mp_planificacion_iniciada.id_plan = $idPlan and t_mp_planificacion_iniciada.id_equipo = $idEquipo and t_mp_planificacion_iniciada.semana = $semanaX and t_mp_planificacion_iniciada.activo = 1 and t_mp_planificacion_iniciada.año = $añoActual and t_mp_planificacion_iniciada.status = 'PROCESO'";

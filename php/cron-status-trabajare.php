...
$APIERROR = 'https://api.telegram.org/bot1396322757:AAF5C0bcZxR8_mEEtm3BFEJGhgHvLcE3X_E/sendMessage?chat_id=989320528&text=STATUS: ';
$resp = "FALLO INCIDENCIAS";
$query = "UPDATE t_mc SET status_trabajare = '' WHERE status_trabajare != ''";
if ($result = mysqli_query($conn_2020, $query)) {
	$resp = "T = Restaurado en Incidencias EQUIPOS";
}
...
if ($result = mysqli_query($conn_2020, $query)) {
	$resp = "T = Restaurado en Incidencias Generales";
}
file_get_contents($APIERROR . $resp);
...
if ($result = mysqli_query($conn_2020, $query)) {
	$resp = "T = Restaurado en PREVENTIVOS";
}
file_get_contents($APIERROR . $resp);
...
if ($result = mysqli_query($conn_2020, $query)) {
	$resp = "T = Restaurado en PLANES DE ACCIÓN";
}
file_get_contents($APIERROR . $resp);
// Fin de la función.

...
Class Layout {
    ...
    public function menu($destino) {
        ...
        $salida = "<ul class=\"list-unstyled components\">"
                ...
                . " <li>"
                . "<a href=\"agenda.php\">"
                . "<span class=\"align-text-top  t-normal-menu\">Agenda Personal</span>"
                . "</a>"
                . "</li>"
                . "</ul>"
                . "</li>"
                ...
                //Materiales
                . "<li>"
                . "<a href=\"#materiales\" data-toggle=\"collapse\" aria-expanded=\"false\" class=\"dropdown-toggle\"><span class=\" t-normal-menu align-text-top\">Gestion de Materiales y Servicios</span></a>"
                ...
                . "</li>"
//                . "<li>"
//                . "<a href=\"stock/stock.php\"><span><img src=\"svg/existencias.svg\" width=\"22\"></span><span class=\" t-normal-menu align-text-top\">Stock - Existencias</span></a>"
//                . "</li>"
                . "<li>"
                ...
                . "<span class=\"align-text-top  t-normal-menu\">Instalaciones</span>"
                . "</a>"
                . "<ul class=\"collapse list-unstyled\" id=\"instalaciones\">"
                //Instalaciones - Equipos
                . "<li>"
                . "<a href=\"mantenimiento/equipos.php\" aria-expanded=\"false\"><span class=\"align-text-top  t-normal-menu\">Equipos</span></a>"
                . "</li>"
...
//
                ...
                . "<li>"
                . "<a href=\"task.php\"><span class=\"t-normal-menu  align-text-top\">Pendientes</span></a>"
                . "</li>"
                . "<li>"

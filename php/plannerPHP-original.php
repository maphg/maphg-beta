...
if (isset($_POST['action'])) {
    ...
    if ($action == "obtenerComentarios") {
        ...
        $obj = new Planner();
        $resp = $obj->obtenerComentarios($idEquipo);
        echo json_encode($resp);
    }
...
//                </div>";
    ...
    public function obtenerEquipos($idGrupo, $idDestino, $idCategoria, $idSubcategoria, $idRelCatSubcat, $pagina) {
        ...
        $listaEquipo->listaEquipos = "<div class=\"columns is-gapless my-1 is-mobile tg\">"
                ...
                . "<div class=\"column\"><p class=\"t-titulos\" data-tooltip=\"Mantto. Preventivo: Pendientes\">MP-P</p></div>"
        ...
        $listaEquipo->listaEquipos .= "<div class=\"columns is-gapless my-1 is-mobile hvr-grow-sm manita\">"
                ...
                . "<div class=\"column\">"
                . "<div class=\"columns is-gapless\">"
                . "<div class=\"column\"><p class=\"t-pendientes\" onclick=\"showModal('modal-mc'); obtCorrectivosG($idGrupo, $idDestino, 6, $idSubcategoria, $idRelCatSubcat, 'N');\">$penCategoria</p></div>"
                . "<div class=\"column\"><p class=\"t-solucionado\" onclick=\"showModal('modal-mc'); obtCorrectivosG($idGrupo, $idDestino, 6, $idSubcategoria, $idRelCatSubcat, 'F');\">$solCategoria</p></div>"
                    ...
                    if ($conn->filasConsultadas > 0) {
                        foreach ($equipos as $e) {
                            ...
                            $listaEquipo->listaEquipos .= "<p class=\"message-body\">"
                                    ...
                                    . "<div class=\"column\">"
                                    . "<div class=\"columns is-gapless\">"
//                                    . "<div class=\"column\"><p class=\"t-pendientes\" onclick=\"showModal('modal-mc'); obtDetalleEquipo($idEquipo, $idGrupo, $idDestino, $idCategoria, $idSubcategoria)\">$totalPenEquipo</p></div>"
//                                    . "<div class=\"column\"><p class=\"t-solucionado\" onclick=\"showMPMC('show', 'MC'); obtDetalleEquipo($idEquipo, $idGrupo, $idDestino, $idCategoria, $idSubcategoria)\">$totalSolEquipo</p></div>"
                                    . "<div class=\"column\"><p class=\"t-pendientes\" onclick=\"showModal('modal-mc'); obtCorrectivos($idEquipo, 'N')\">$totalPenEquipo</p></div>"
                                    . "<div class=\"column\"><p class=\"t-solucionado\" onclick=\"showModal('modal-mc'); obtCorrectivos($idEquipo, 'F')\">$totalSolEquipo</p></div>"
                                    . "<div class=\"column\"><p class=\"t-pendientes\" onclick=\"showModal('modal-mp'); obtPreventivos($idEquipo, $idGrupo, $idDestino, $idCategoria, $idSubcategoria)\">$mpPlanificado</p></div>"
                                    . "<div class=\"column\"><p class=\"t-proceso\" onclick=\"showModal('modal-mp'); obtPreventivos($idEquipo, $idGrupo, $idDestino, $idCategoria, $idSubcategoria)\">$mpProceso</p></div>"
                                    . "<div class=\"column\"><p class=\"t-solucionado\" onclick=\"showModal('modal-mp'); obtPreventivos($idEquipo, $idGrupo, $idDestino, $idCategoria, $idSubcategoria)\">$mpRealizado</p></div>"
                                    . "<div class=\"column\"><p class=\"t-normal\">$fechaMPR</p></div>"
                                    . "<div class=\"column\"><p class=\"t-test\" onclick=\"showModal('modal-mp'); obtTest($idEquipo, $idGrupo, $idDestino, $idCategoria, $idSubcategoria)\">$numeroTest</p></div>"
                                    . "<div class=\"column\"><p class=\"t-normal\">$fechaTestR</p></div>"
                                    . "<div class=\"column\">"
                                    . "<p class=\"t-normal\" onclick=\"showModal('modal-equipo-info'); obtenerInfoEquipo($idEquipo);\">"
...
//                            }
    ...
    public function obtenerComentarios($idEquipo) {
        $conn = new Conexion();
        $conn->conectar();
            ...
            if ($conn->filasConsultadas > 0) {
                foreach ($result as $dt) {
                    ...
                    $query = "SELECT t_mp_adjuntos.url_adjunto 'ADJUNTO', "
                            ...
                            . "WHERE t_mp_adjuntos.id_ot = $idOT ORDER BY t_mp_adjuntos.fecha";
                    try {
                        $result = $conn->obtDatos($query);
                        if ($conn->filasConsultadas > 0) {
                            foreach ($result as $dt) {
                                ...
                                $equipo->fotosMCMPM .= "<div class=\"timeline-item\">"
                                        ...
                                        . "</div>"
                                        . "</div>"
                                        . "<img class=\"ximg\" src=\"planner/mp/$fotosMP\" alt=\"\">"
                                        . "</div>"
                                        . "</div>";
                            }
                        }
            ...
            if ($conn->filasConsultadas > 0) {
                foreach ($resp as $dts) {
                    ...
                    $query = "SELECT t_mc_adjuntos.url_adjunto 'ADJUNTO', "
                            ...
                            . "WHERE t_mc_adjuntos.id_mc = $idMC ORDER BY t_mc_adjuntos.fecha";
                    try {
                        $result = $conn->obtDatos($query);
                        if ($conn->filasConsultadas > 0) {
                            foreach ($result as $dt) {
                                ...
                                $equipo->fotosMCMPM .= "<div class=\"timeline-item\">"
                                        ...
                                        . "</div>"
                                        . "</div>"
                                        . "<img class=\"ximg\" src=\"planner/tareas/adjuntos/$fotosMC\" alt=\"\">"
                                        . "</div>"
                                        . "</div>";
                            }
                        }
...
//                . "</div>"
                . "<div class=\"navbar-item\">"
                . "<button type=\"button\" class=\"button is-warning\" name=\"button\" onclick=\"closeModal('modal-equipo-info');\">"
                . "<i class=\"fas fa-times\"></i>"
                . "</button>"
                . "</div>"
                . "</div>"
            ...
            if ($conn->filasConsultadas > 0) {
                foreach ($resp as $dts) {
                    ...
                    $equipo->correctivos .= "</div>"
                            . "<div class=\"column\">";
                    if ($status == "N") {
                        $equipo->correctivos .= "<p class=\"t-solucionado\" onclick=\"completarTarea($idMC, this, " . $_SESSION["usuario"] . ")\">SOLUCIONAR</p>";
                    } else {
                        $equipo->correctivos .= "<p class=\"t-solucionado\">SOLUCIONAR</p>";
                    }
                    $equipo->correctivos .= "</div>"
                            . "</div>"
                            . "</div>"
            ...
            if ($conn->filasConsultadas > 0) {
                foreach ($resp as $dts) {
                    ...
                    $equipo->fotosGenerales .= "<div class=\"timeline-item\">"
                            . "<div class=\"timeline-marker\"></div>"
                            . "<div class=\"timeline-content\">"
                            . "<p class=\"heading\"><strong>$nombre $apellido</strong><button class=\"is-delete is-size-7 manita\" onclick=\"borrarFotosMC($idAdjunto, $idMC);\">Borrar</button></p>"
                            . "<p class=\"heading\">$fecha</p>"
                            . "<img class=\"ximg\" src=\"planner/tareas/adjuntos/$urlFoto\" alt=\"\">"
                            . "</div>"
                            . "</div>";
                }
            }

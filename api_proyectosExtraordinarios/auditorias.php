...
class Auditorias extends Conexion
{
    ...
    public static function Grupos($post)
    {
        ...
        d.destino,
        d.ubicacion
        FROM  t_proyectos_extraordinarios AS a
    ...
    public static function addGrupo($post)
    {
        ...
        $query = "INSERT INTO t_proyectos_extraordinarios(
        id_destino,
        grupo,
        fecha_creado,
        creado_por,
    ...
    public static function updateGrupo($post)
    {
        ...
        $query = "UPDATE t_proyectos_extraordinarios SET grupo = ?, activo = ? WHERE id = ?";
    ...
    public static function Tareas($post)
    {
        ...
        at.activo
        FROM  t_proyectos_extraordinarios AS a
        INNER JOIN t_proyectos_extraordinarios_tareas AS at ON a.id = at.id_auditoria
        INNER JOIN c_destinos AS d ON a.id_destino = d.id
    ...
    public static function addTarea($post)
    {
        ...
        $query = "INSERT INTO t_proyectos_extraordinarios_tareas
        (
        id_auditoria,
        descripcion,
        id_responsable,
    ...
    public static function updateTarea($post)
    {
        ...
        $query = "UPDATE t_proyectos_extraordinarios_tareas SET
        descripcion = ?,
        justificacion = ?,
        id_responsable = ?,
        estado = ?,
    ...
    public static function TareasComentarios($idTarea)
    {
        ...
        FROM  t_proyectos_extraordinarios_tareas_comentarios AS atc
    ...
    public static function addTareasComentarios($post)
    {
        ...
        $query = "INSERT INTO t_proyectos_extraordinarios_tareas_comentarios(id_auditoria_tarea, comentario, fecha_creado, creado_por, activo) VALUES(?,?,?,?,?)";
    ...
    public static function TareasAdjuntos($idTarea)
    {
        ...
        if (strpos($_SERVER['REQUEST_URI'], "america") == true) {
            $rutaAbsoluta = "https://maphg.com/america/proyectosExtraordinarios/adjuntos/";
        }

        if (strpos($_SERVER['REQUEST_URI'], "europa") == true) {
            $rutaAbsoluta = "https://maphg.com/europa/proyectosExtraordinarios/adjuntos/";
        }

        if (strpos($_SERVER['REQUEST_URI'], "maphg-beta") == true) {
            $rutaAbsoluta = "../maphg-beta/proyectosExtraordinarios/adjuntos/";
        }
        ...
        CONCAT(c.nombre, ' ', c.apellido) 'creadoPor'
        FROM  t_proyectos_extraordinarios_tareas_adjuntos AS ata
    ...
    public static function addTareasAdjuntos($post)
    {
        ...
        $query = "INSERT INTO t_proyectos_extraordinarios_tareas_adjuntos(id_auditoria_tarea, url, descripcion, posicion, extension, fecha_creado, creado_por, activo) VALUES(?,?,?,?,?,?,?,?)";

...
<body class=" bg-fondos-7 text-bluegray-800">
    ...
    <div class="flex flex-row container mx-auto text-base mb-6">
        <input id="filtroPalabra" type="search" name="" placeholder="Buscar Equipo o local"
            class="w-1/4 px-3 mr-6 bg-white focus:outline-none py-2 rounded-lg shadow-md">
        ...
        <div class="flex flex-col pl-4 w-1/6">
            ...
            <div class="relative ">
                <select id="filtroDestino"
                    class="w-full border border-gray-200 text-gray-700 rounded-lg leading-tight focus:outline-none hover:bg-gray-200 focus:border-gray-500 mx-2 bg-white">
                </select>
            </div>
        </div>
        ...
        <div class="modal-window flex shadow-lg flex-col justify-center items-center text-bluegray-800 pt-10 rounded-lg "
            ...
            <div class="flex flex-row w-full justify-start px-4 relative">
                <div
                    ...
                    <input id="nombreEquipo" type="text"
                        ...
                        value="Maquina de hielo edificio 1226 grand palladium" autocomplete="off">
                    <div class="flex mt-1">
                        <div id="contenedorEstadoEquipo"
                            class="flex items-center px-1  rounded-full w-auto cursor-pointer mr-4">
            ...
            <div class="w-full h-32 mt-2 px-4 overflow-x-auto scrollbar flex items-center">
                <div id="btnAdjuntosEquipo"
                    class="flex items-center justify-center w-10 h-10 bg-bluegray-900 hover:bg-indigo-300 hover:text-indigo-500 border-2 border-gray-200 text-bluegray-300 rounded-full absolute left-0 cursor-pointer"
                    data-anijs="if: mouseover, do: tada animated">
                ...
                <div class="bg-cover bg-center w-24 h-24 rounded-lg cursor-pointer flex-none mr-2 hover:shadow-lg">
                    <img id="QREquipo" class=""
                        src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&format=svg&bgcolor=fff&color=4a5568&data=www.maphg.com/beta/#">
                </div>
            ...
            <div class="flex flex-row w-full bg-fondos-4">
                <div
                    ...
                    <div class="flex-none w-1/6">
                        ...
                        <div id="contenedorDataOpcionesEquipos"
                            class="flex flex-col justify-center items-start uppercase leading-tight mb-4 hidden">
    ...
    <div id="modalSolucionarOT" class="modal">
        <div class="modal-window rounded-md pt-10" style="width: 1000px;">
            <!-- BOTON CERRARL -->
            <div class="absolute top-0 right-0">
                <button onclick="cerrarmodal('modalSolucionarOT')"
            ...
            <div class="absolute top-0 left-0 ml-4 flex flex-row items-center">
                <div
                    class="flex flex-col leading-none justify-center items-center bg-bluegray-900 rounded-b-md w-16 h-10">
                ...
                <div class="flex w-full text-sm mt-4">
                    <div class="w-1/2 flex flex-col items-start justify-start">
                        <div class="flex flex-col w-full ">
                            ...
                            <div id="actividadesOT"
                                class="flex flex-col w-full border-2 border-gray-300 text-xs rounded p-1 overflow-y-auto scrollbar"
                                style="max-height: 251px; height: 250px;"></div>
                        </div>

                        <div class="flex flex-col w-full p-2 mt-2 text-xs">
                            <h1 class="mb-2">Actividades Extra</h1>
                            <div class="w-full">
                                <input id="inputActividadesExtra" type="text" placeholder="Añadir Actividad Extra..."
                                    class="w-full p-2 border border-gray-200 rounded mb-1" autocomplete="off">
                            </div>

                            <div id="actividadesExtraOT" class="w-full overflow-y-auto scrollbar"
                                style="max-height: 200px; height: 199px;"></div>
                    ...
                    <div class="w-1/2 flex flex-col items-start justify-start px-4">
                        ...
                        <div class="w-full">
                            <textarea id="comentarioOT" cols="30" rows="5"
                                class="w-full  border-2 border-gray-300 rounded leading-none"></textarea>
                        </div>

                        <div class="flex w-full mb-2">
                            <h1 class="mr-2">Archivos Adjuntos</h1>
                            <div id="btnAdjuntosOT"
                                ...
                                onclick="toggleModalTailwind('modalMedia');">
                        ...
                        <div class="w-full">
                            <div
                                class="w-full px-1 font-medium text-sm text-gray-400 overflow-y-auto scrollbar border-2 border-gray-300 rounded">
                                <div id="imagenesOT"
                                    class="flex flex-row flex-wrap justify-evenly items-start overflow-y-auto scrollbar mb-4"
                                    style="max-height: 300px;"></div>
                                <div id="documentosOT" class="flex flex-col overflow-y-auto scrollbar px-1 mb-4 text-xs"
                                    style="max-height: 300px;"></div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="tooltipMP" role="tooltip" class="flex flex-col items-center justify-center mx-auto contextmenu-menu hidden"
        ...
        <i class="fas fa-sort-down w-full text-center fa-4x "
            style="color: #414646; margin-top: -29px; margin-bottom: -12.5px; z-index:85;"></i>
    </div>
    <!-- MENÚ OPCIONES MP -->
    ...
    <div id="tooltipActividadesMP" role="tooltip"
        ...
        style="z-index:100; max-width: 350px; max-height: 400px;" style="z-index:100">
    </div>
    <!-- ACTIVIDADES MP -->

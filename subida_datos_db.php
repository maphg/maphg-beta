    ...
    <script>
        ...
        function obtenerNombreColumnas() {
            ...
            if (tabla == "t_gastos_servicios") {
                ...
                document.getElementById("columna1").value = "ceco";
                document.getElementById("columna2").value = "id_destino";
                document.getElementById("columna3").value = "departamento";
                document.getElementById("columna4").value = "solicitud_pedido";
                document.getElementById("columna5").value = "fecha_solicitud";
                document.getElementById("columna6").value = "documento_compras";
                document.getElementById("columna7").value = "fecha_entrega";
                document.getElementById("columna8").value = "fecha_documento";
                document.getElementById("columna9").value = "proveedor";
                document.getElementById("columna10").value = "material";
                document.getElementById("columna11").value = "texto_breve";
                document.getElementById("columna12").value = "cantidad_pedido";
                document.getElementById("columna13").value = "precio_neto";
                document.getElementById("columna14").value = "cantidad_por_entregar	";
                document.getElementById("columna15").value = "almacen";
                document.getElementById("columna16").value = "unidad_medida_almacen";
                document.getElementById("columna17").value = "moneda";
                document.getElementById("columna18").value = "valor_por_entregar";
                document.getElementById("columna19").value = "grupo_de_compras";
                document.getElementById("columna20").value = "centro";
                document.getElementById("columna21").value = "reg_info_compras";
                document.getElementById("columna22").value = "valor_usd";
                document.getElementById("columna23").value = "id_seccion";
                document.getElementById("columna24").value = "id_subseccion";
                document.getElementById("columna25").value = "tipo";
                document.getElementById("columna26").value = "comentarios";
                document.getElementById("columna27").value = "status";
                document.getElementById("columna28").value = "";
                document.getElementById("columna29").value = "";
                document.getElementById("columna30").value = "";
                ...
                document.getElementById("columna1").value = 'id_destino';
                document.getElementById("columna2").value = 'id_gremio';
                document.getElementById("columna3").value = 'barcode';
                document.getElementById("columna4").value = 'cod2bend';
                document.getElementById("columna5").value = 'descripcion';
                document.getElementById("columna6").value = 'marca';
                document.getElementById("columna7").value = 'modelo';
                document.getElementById("columna8").value = 'caracteristicas';
                document.getElementById("columna9").value = 'tipo_material';
                document.getElementById("columna10").value = 'unidad';
                document.getElementById("columna11").value = 'precio';

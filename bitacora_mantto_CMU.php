...
<body class="bg-gray-300" style="font-family: 'Manrope', sans-serif;">
    ...
    <div class="w-full flex flex-row items-center justify-center">
		<h1 class=" my-12 font-semibold text-gray-500 text-sm">Este informe se genera de forma dinámica mostrando información generada de 7:00 pm del día anterior a 7:00 pm del día actual.</h1>
    </div>

...
<body class="h-screen">
    ...
    <script>
        ...
        function cambiarDestino(idDestino) {
            localStorage.setItem('idDestinoInvitado', idDestino);
            document.getElementById("destinosSelecciona").classList.remove('hidden');
            graficos();
            ...
            } else if (idDestino == 11) {
                document.getElementById("destinoNavBarTop").innerHTML = 'CAP';
            } else if (idDestino == 3) {
                document.getElementById("destinoNavBarTop").innerHTML = 'SDQ';
            } else {
                document.getElementById("destinoNavBarTop").innerHTML = 'AME';
            }
        }
        cambiarDestino(10);
        graficos();
        ...
        function camaras() {
            let idDestino = localStorage.getItem('idDestinoInvitado');
        ...
        function pendientes() {
            ...
            document.getElementById("iframPendientes").src = 'https://www.maphg.com/beta/modalPendientes.php?idSeccion=11&tipoPendiente=MCS&idUsuario=0&idDestino=' + idDestino;
        }
    </script>

...
<body class="h-screen">
    ...
    <script>
        ...
        function pendientes() {
            ...
            document.getElementById("iframPendientes").src = 'https://www.maphg.com/america/modalPendientes.php?idSeccion=11&tipoPendiente=MCS&idUsuario=0&idDestino=' + destino;
        }

...
<body class="bg-gray-300" style="font-family: 'Manrope', sans-serif;">
    ...
    <div class="flex flex-col flex-wrap justify-start items-center">
        ...
        <div class="w-full flex flex-row justify-center flex-wrap">
            ...
            <div class="flex flex-row justify-center items-center w-full mt-4">
                <!-- ESPACIO DEL WIDGET -->
                <h1 class="text-2xl font-light text-gray-700 text-center">Bitácora Diaria de <strong
                        class=" font-semibold">Mantenimiento</strong></h1>
            </div>
            <!-- ESPACIO DEL WIDGET -->
            ...
            <div class="flex flex-row justify-center items-center w-auto mt-2 mx-2">
                <div class="inline-block w-auto relative">
                    <select id="idDestino"
                        ...
                        onclick="funcionNombre('gremioCantidad'); funcionNombre('cantidadTurno'); funcionNombre('MPMCPROYECTOS');funcionNombre('empresasExternasConsulta'); funcionNombre('acontecimientoConsulta'); funcionNombre('giftHabitacionesConsulta'); funcionNombre('giftCocinasConsulta');">
                        <?php
                        if ($idDestino != 10) {
            ...
            <div class="flex flex-row justify-center items-center w-auto mt-2 mx-2">
                ...
                <div class="inline-block w-auto relative">
                    <select id="zona"
                        class="block appearance-none w-full bg-white border border-grey-light hover:border-grey px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline font-black text-gray-700"
                        onclick="funcionNombre('cantidadTurno'); funcionNombre('MPMCPROYECTOS'); funcionNombre('empresasExternasConsulta'); funcionNombre('acontecimientoConsulta'); funcionNombre('giftHabitacionesConsulta'); funcionNombre('giftCocinasConsulta'); ocultarGift();">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0"
                                            ...
                                            <div class="flex flex-wrap -mx-1"
                                                onclick="funcionNombre('MPMCPROYECTOS'); funcionNombre('cantidadTurno'); funcionNombre('empresasExternasConsulta'); funcionNombre('acontecimientoConsulta'); funcionNombre('giftHabitacionesConsulta'); funcionNombre('giftCocinasConsulta');">
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="cursor-pointer flex self-start my-3"
                onclick="funcionNombre('gremioCantidad'); funcionNombre('cantidadTurno');">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-personal" data-toggle="modal"
                    class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-blue-400 mr-1"></i></span>Personal</h1>
            </div>
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                ...
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    <!-- ESPACIO DEL WIDGET -->
                    <div
                        class="w-56 h-56 bg-white shadow-md rounded-md flex flex-col items-center justify-center leading-none">
                        <!--WIDGET CUADRADO-->
                        <h1 class="text-gray-700 font-bold text-6xl "><span id="totalgremio1">55</span><span
                                id="totalColaboradores1" class="text-3xl text-gray-500">/50</span></h1>
                        <h1 class="text-gray-600 font-medium text-sm">Colaboradores</h1>
                        <h1 class=" font-semibold text-blue-400 bg-blue-200 py-1 px-3 mt-3 rounded-full">Primer
                            turno</h1>
                    </div>
                </div>
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        class="w-56 h-56 bg-white shadow-md rounded-md flex flex-col items-center justify-center leading-none">
                        <!--WIDGET CUADRADO-->
                        <h1 class="text-gray-700 font-bold text-6xl "><span id="totalgremio2">55</span><span
                                id="totalColaboradores2" class="text-3xl text-gray-500">/50</span></h1>
                        <h1 class="text-gray-600 font-medium text-sm">Colaboradores</h1>
                        <h1 class=" font-semibold text-blue-400 bg-blue-200 py-1 px-3 mt-3 rounded-full">Segundo
                            turno</h1>
                    </div>
                </div>
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        class="w-56 h-56 bg-white shadow-md rounded-md flex flex-col items-center justify-center leading-none">
                        <!--WIDGET CUADRADO-->
                        <h1 class="text-gray-700 font-bold text-6xl "><span id="totalgremio3">55</span><span
                                id="totalColaboradores3" class="text-3xl text-gray-500">/50</span></h1>
                        <h1 class="text-gray-600 font-medium text-sm">Colaboradores</h1>
                        <h1 class=" font-semibold text-blue-400 bg-blue-200 py-1 px-3 mt-3 rounded-full">Tercer
                            turno</h1>
                    </div>
                </div>
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="flex self-start my-3" onclick="funcionNombre('MPMCPROYECTOS');">
                ...
                <h1 class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-red-400 mr-1"></i></span>MP / MC / PROYECTOS</h1>
            </div>
            ...
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                ...
                <div id="bitacoraMC"
                    class="flex flex-col items-center justify-start w-screen md:w-1/2 mb-3 mx-4 bg-white rounded h-56 shadow-md p-2 overflow-auto">
                    <!-- ESPACIO DEL WIDGET -->
                    <!-- ITEM DE CORRECTIVO ........................................................................................................................... -->
                </div>
                <div class="flex flex-row items-center justify-center w-auto mb-3">
            ...
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                ...
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        ...
                        <h1 class=" font-semibold text-yellow-400 bg-yellow-200 py-1 px-3 mt-3 rounded-full">
                            PROYECTOS</h1>
                    </div>
                </div>
                <div id="bitacoraProyecto"
                    class="flex flex-col items-center justify-start w-screen md:w-1/2 mb-3 mx-4 bg-white rounded h-56 shadow-md p-2 overflow-auto">
                </div>
        ...
        <div id="seccion4Gift" class="w-full flex flex-col items-center flex-wrap">
            ...
            <div class="cursor-pointer flex self-start flex-row my-3"
                onclick="funcionNombre('giftHabitacionesConsulta')">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-gift" data-toggle="modal"
                    class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-green-400 mr-1"></i></span>GIFT</h1>
                <h1 data-target="modal-gift" data-toggle="modal"
                    class="text-red-400 bg-red-200 px-3 py-3 uppercase rounded-full font-semibold my-3 ml-4 shadow">
                    Habitaciones</h1>
            </div>
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                <!-- CONTENEDOR WIDGETS DE SECCION -->
                ...
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        class="w-56 h-56 bg-white shadow-md rounded-md flex flex-col items-center justify-center leading-none">
                        <!--WIDGET CUADRADO-->
                        <h1 class="text-green-400 font-bold text-6xl "><span id="solucionadoGH">0</span><span
                                class="text-3xl text-yellow-400">/<span id="pendienteGH">0</span></span></h1>
                        <h1 class="text-gray-600 font-medium text-sm">Solucionado/En proceso</h1>
                        <h1 class=" font-semibold text-green-400 bg-green-200 py-1 px-3 mt-3 rounded-full">Averias
                        </h1>
                    </div>
                </div>
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        ...
                        <h1 class=" font-semibold text-sm text-gray-700 bg-gray-400 py-1 px-3 rounded-full my-1">
                            Media Solucion</h1>
                ...
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        ...
                        <h1 class=" font-semibold text-green-400 bg-green-200 py-1 px-3 mt-3 rounded-full">
                            Satisfaccion</h1>
                    </div>
                </div>
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
            ...
            <div class="cursor-pointer flex self-start flex-row my-3" onclick="">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-cobare" data-toggle="modal"
                    class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-green-400 mr-1"></i></span>GIFT</h1>
                <h1 data-target="modal-cobare" data-toggle="modal"
                    class="text-red-400 bg-red-200 px-3 py-3 uppercase rounded-full font-semibold my-3 ml-4 shadow">
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="cursor-pointer flex self-start my-3" onclick="funcionNombre('empresasExternasConsulta');">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-empresas" data-toggle="modal"
                    class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-blue-400 mr-1"></i></span>EMPRESAS EXTERNAS</h1>
            </div>
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                <!-- CONTENEDOR WIDGETS DE SECCION -->
                ...
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        ...
                        <h1 class=" font-semibold text-blue-400 bg-blue-200 py-1 px-3 mt-3 rounded-full">Empresas
                            Externas</h1>
                    </div>
                </div>
                <div id="registroEmpresas"
                    class="flex flex-col items-center justify-start w-screen md:w-1/4 mb-3 mx-4 bg-white rounded h-56 shadow-md p-2 overflow-auto">
                    <!-- ESPACIO DEL WIDGET -->
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="cursor-pointer  self-start my-3">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-acontecimientos" data-toggle="modal"
                    class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-yellow-400 mr-1"></i></span>ACONTECIMIENTOS</h1>
            </div>
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                <!-- CONTENEDOR WIDGETS DE SECCION -->
                ...
                <div class="flex flex-row items-center justify-center w-auto mb-3 mx-4">
                    ...
                    <div
                        ...
                        <h1 class=" font-semibold text-yellow-700 bg-yellow-200 py-1 px-3 mt-3 rounded-full">
                            Acontecimientos</h1>
                    </div>
                </div>
                <div id="registroAcontecimiento"
                    class="flex flex-col items-center justify-start w-screen md:w-1/4 mb-3 mx-4 bg-white rounded h-56 shadow-md p-2 overflow-auto">
                </div>
                <div class="flex flex-row items-center justify-center w-auto mb-3">
                    <!-- ESPACIO DEL WIDGET -->
    ...
    <div class="w-full flex flex-row items-center justify-center">
        <h1 class=" my-12 font-semibold text-gray-500 text-sm">Este informe se genera de forma dinámica mostrando
            información generada de 7:00 pm del día anterior a 7:00 pm del día actual.</h1>
    </div>
    ...
    <div id="modal-personal" class="modal">
        <div class="modal-window w-full md:w-2/4 rounded-lg">
            ...
            <div class="flex flex-col flex-wrap justify-center items-center">
                ...
                <div
                    class="flex justify-center mb-6 p-4 w-full bg-gray-300 uppercase text-gray-600 text-xl font-bold rounded-lg">
                ...
                <div class="flex flex-col flex-wrap mb-6">
                    ...
                    <div class=" relative">
                        <select id="turnoSeleccionado"
                            ...
                            id="grid-state" onclick="turnoSeleccionado(); funcionNombre('gremioCantidad');">
                ...
                <div class="flex flex-col flex-wrap mb-6">
                    <div class="w-auto px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Total de
                            la plantilla</label>
                        <input id="totalPlantillaPorTurno"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            type="number" min="0" placeholder="Total" pattern="[0-9]">
                    </div>
                </div>
                ...
                <div class=" flex flex-row flex-wrap justify-center items-center">
                    ...
                    <div class="flex flex-r flex-wrap mb-6">
                        <div class="w-auto px-3">
                            <label
                                class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Gremio</label>
                            <div class=" relative">
                                <select id="gremio"
                                    class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="grid-state">
                    ...
                    <div class="flex flex-col flex-wrap mb-6">
                        <div class="w-auto px-3">
                            <label
                                class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Cantidad</label>
                            <input id="cantidadPorGremio"
                                class=" appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                type="number" placeholder="Cantidad" min="0" placeholder="Total" pattern="[0-9]">
                        </div>
                    </div>
                    <div class=" flex">
                        <button
                            class="bg-blue-300 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-400 hover:border-blue-500 rounded"
                            onclick="bitacoraPersonal(); funcionNombre('gremioCantidad'); funcionNombre('cantidadTurno');">
                            Agregar
                        </button>
                    </div>
                </div>
                <div id="gremioCantidad" class="flex flex-col flex-wrap mb-6 bg-gray-200 p-4 rounded-md">
                    <h1 class="font-semibold text-xl text-gray-500"><span>0</span> Sin Datos <span><i
                                class="fad fa-times-circle text-red-400 text-xl"></i></span></h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <form class="w-full">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftHPendientes"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Pendientes">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="giftHSolucionados"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Solucionados">
                    </div>
                </div>

                <div class="text-center py-4 lg:px-4">
                    <div
                        class="p-2 bg-gray-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/3 px-3">
                        ...
                        <input id="giftHMediaSolucion"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="0d 5h 20m">
                    </div>
                    <div class="w-full md:w-1/3 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/3 px-3">
                        ...
                        <input id="giftHSatisfaccion"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Satisfaccion">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/3 px-3">
                        ...
                        <input id="giftHNoAlojadoOrigen"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="No alojado">
                    </div>
                    <div class="w-full md:w-1/3 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="giftHTrabajadorOrigen"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Trabajador">
                    </div>
                    <div class="w-full md:w-1/3 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="giftHHuspedOrigen"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Huesped">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftHTTop1"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Averia">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="giftHTop1"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Total">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
    ...
    <div id="modal-cobare" class="modal">
        <div class="modal-window w-full md:w-2/5 rounded-lg flex flex-col items-center justify-center">
            ...
            <form class="w-full">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasPendientes"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Pendientes">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasSolucionados"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Solucionados">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/3 px-3">
                        ...
                        <input id="giftCocinasMediaSolucion"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="0d 0h 0m">
                    </div>
                    <div class="w-full md:w-1/3 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="giftCocinasMediaAsignacion"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="0d 0h 0m">
                    </div>
                    <div class="w-full md:w-1/3 px-3">
                        ...
                        <input id="giftCocinasMediaReparacion"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="0d 0h 0m">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasAveriaTop1"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Averia">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasAveriasTop2"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Averia">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasAveriasTop3"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Averia">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasAveriasTop4"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Averia">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="giftCocinasAveriasTop5"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Averia">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
            ...
            <div class="w-full md:w-1/2 px-3 text-center">
                <div id="btnGiftCocinas"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full cursor-pointer"
                    onclick="funcionNombre('giftCocinasCaptura'); funcionNombre('giftCocinasConsulta');">
                    Agregar
                </div>
            </div>
            <!-- CONTENIDO MODAL -->
            ...
            <form class="w-full">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="bitacoraNombreEmpresaExterna"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Empresa">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="bitacoraMotivoEmpresaExterna"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Motivo"
                            onkeyup="if(event.keyCode == 13) funcionNombre('empresasExternasCaptura')">
                    </div>
                </div>
            ...
            <form class="w-full">
                <div class="text-center py-4 lg:px-4">
                    <div class=" p-2 bg-gray-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
                        onclick="funcionNombre('acontecimientoCaptura')">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input id="bitacoraAcontecimiento"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Titulo">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                            for="grid-last-name">
                        ...
                        <input id="bitacoraAcontecimientoDescripcion"
                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            id="grid-last-name" type="text" placeholder="Descripcion"
                            onkeyup="if(event.keyCode == 13) funcionNombre('acontecimientoCaptura')">
                    </div>
                </div>
                <div id="bitacoraAcontecimientoConsulta"
                    class="flex flex-wrap flex-col bg-gray-200 items-start justify-center m-10 p-2 font-bold ">
                    <div class="px-3 flex justify-between my-2">
                        <h1>Titulo del acontecimiento</h1>
                        <h1 class="mx-3"> / </h1>
                        <h1>Descripcion <span><i class="ml-3 fad fa-times-circle text-red-400 text-xl"></i></span>
                        </h1>
                    </div>
                </div>
            </form>
    ...
    <!-- Modal para información detallada de  MC-MP-Proyectos -->
    <div id="modalMCMPProyectos" class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
        <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"
            onclick="toggleModal('modalMCMPProyectos');">
        </div>
        <div
            ...
            <div class="mb-4 w-full">
                <p class="font-black">DESTINO:
                    <span id="destinoModalMCMPProyectos" class="font-normal">nombre de la seccion</span>
                </p>
            </div>
            ...
            <div class="mb-4 w-full">
                <p class="mt-3 font-black">SUBSECCIÓN: <span id="subseccionModalMCMPProyectos" class="font-normal">Sin
                        Información</span></p>
            </div>

            <div class="mb-4 w-full">
                <p class="mt-3 font-black">DESCRIPCIÓN: <span id="descripcionModalMCMPProyectos" class="font-normal">Sin
                        Información</span></p>
            </div>

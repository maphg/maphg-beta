...
<body class="bg-gray-300" style="font-family: 'Manrope', sans-serif;">
    ...
    <div class="flex flex-col flex-wrap justify-start items-center">
        ...
        <div class="w-full flex flex-row justify-center flex-wrap">
                            ...
                            <div class="container mx-auto px-4 py-2 md:py-10">
                                <div class="mb-5 w-64">
                                    <div class="relative">
                                        ...
                                        <input id="dateGenerald" type="text" readonly x-model="datepickerValue" @click="showDatepicker = !showDatepicker" @keydown.escape="showDatepicker = false" class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Fecha Selecionada">
            ...
            <div class="flex flex-row justify-center items-center w-auto mt-2 mx-2">
                <div class="sans-serif inline-block w-auto relative">
                    <input id="dateGeneral" class="block appearance-none w-full bg-white border border-grey-light hover:border-grey px-5 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline font-black text-gray-700" type="date" placeholder="" value="<?= date('Y-m-d') ?>" min="2020-01-01" max="2030-12-31">
                </div>
            </div>

            <!-- Button para Cargar los Filtros Destino - Energetico - Fecha -->
            <div class="flex flex-row justify-center items-center w-auto mt-2 mx-2">
                <div class="block appearance-none bg-white border border-grey-light hover:border-grey cursor px-5 py-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline font-black text-gray-700 cursor-pointer" onclick="funcionNombre('MPMCPROYECTOS'); funcionNombre('cantidadTurno'); funcionNombre('empresasExternasConsulta'); funcionNombre('acontecimientoConsulta');">
                    Buscar
                </div>
            </div>
        </div>
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="cursor-pointer flex self-start my-3" onclick="funcionNombre('gremioCantidad'); funcionNombre('cantidadTurno');">
                ...
                <h1 data-target="modal-personal" data-toggle="modal" class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
        ...
        <div id="seccion4Gift" class="w-full flex flex-col items-center flex-wrap">
            ...
            <div class="cursor-pointer flex self-start flex-row my-3" onclick="funcionNombre('giftHabitacionesConsulta')">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-gift" data-toggle="modal" class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-green-400 mr-1"></i></span>GIFT</h1>
                <h1 data-target="modal-gift" data-toggle="modal" class="text-red-400 bg-red-200 px-3 py-3 uppercase rounded-full font-semibold my-3 ml-4 shadow">
                    Habitaciones</h1>
            </div>
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                <!-- CONTENEDOR WIDGETS DE SECCION -->
            ...
            <div class="cursor-pointer flex self-start flex-row my-3" onclick="">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-cobare" data-toggle="modal" class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
                    <span><i class="fad fa-circle text-sm text-green-400 mr-1"></i></span>GIFT</h1>
                <h1 data-target="modal-cobare" data-toggle="modal" class="text-red-400 bg-red-200 px-3 py-3 uppercase rounded-full font-semibold my-3 ml-4 shadow">
                    COCINAS</h1>
            </div>
            <div class="flex flex-row flex-wrap justify-center items-center w-full">
                <!-- CONTENEDOR WIDGETS DE SECCION -->
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="cursor-pointer flex self-start my-3" onclick="funcionNombre('empresasExternasConsulta');">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-empresas" data-toggle="modal" class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
        ...
        <div class="w-full flex flex-col items-center flex-wrap">
            <div class="cursor-pointer  self-start my-3">
                <!-- CONTENEDOR DE TITULO -->
                <h1 data-target="modal-acontecimientos" data-toggle="modal" class="text-gray-200 bg-gray-900 pl-4 pr-3 py-3 uppercase rounded-r-full font-semibold my-3">
    ...
    <div id="modalMCMPProyectos" class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
        <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50" onclick="toggleModal('modalMCMPProyectos');">
        </div>
        <div class="flex flex-col items-start justify-center sm:w-full md:w-4/12 h-auto p-4 rounded-lg shadow-sm bg-white divide-y divide-gray-400 relative">
            ...
            <div class="mb-4 w-full">
                <p class="mt-3 font-black">ULTIMO COMENTARIO: <span id="comentarioModalMCMPProyectos" class="font-normal">Sin comentarios"</span></p>
            </div>

            <div class=" w-full">
                <p class="mt-3 font-black">STATUS:
                    <span id="status1ModalMCMPProyectos" class="font-black text-lg text-blue-600 mx-1 bg-blue-300 px-2 rounded-md">Sin
                        Información</span>

                    <span id="status2ModalMCMPProyectos" class="font-black text-lg text-green-600 mx-1 bg-green-300 px-2 rounded-md">Sin
                        Información</span>
                </p>
            </div>

            <div class="absolute top-0 right-0 mr-3 cursor-pointer text-gray-600 text-xl" onclick="toggleModal('modalMCMPProyectos');">

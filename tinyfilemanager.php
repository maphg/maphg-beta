...
$CONFIG = '{"lang":"es","error_reporting":true,"show_hidden":true,"hide_Cols":false,"calc_folder":false}';
...
//Application Title
define('APP_TITLE', 'MAPHG - Explorador de archivos');
...
$root_path = $_SERVER['DOCUMENT_ROOT']."/maphg_v2.0/file-browser/maphg/";
//$root_path = $_SERVER['DOCUMENT_ROOT']."/beta/repositorio/maphg/";
//$root_path = $_SERVER['DOCUMENT_ROOT'] . "/beta/repositorio/maphg/";
...
//    $file_url = FM_ROOT_URL ."/beta/repositorio/maphg/". fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_url = FM_ROOT_URL ."/bulmaTest/repositorio/maphg/". fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_path = $path . '/' . $file;
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            if ($path != '') {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    $array[] = "<a href='#'>" . fm_enc(fm_convert_win($exploded[$i])) . "</a>";
                }

...
class ReporteRanking extends Conexion
{
   ...
   public static function incidenciasSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      ...
      $subsecciones = seccionesSubsecciones::subsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin);
      ...
      foreach ($subsecciones as $x) {
         ...
         #DATA ARRAY
         if (
            $idSeccionX != 1001 && $idSubseccion != 200
         )
            $arraySecciones[] = array(
               "idSeccion" => $idSeccionX,
               "seccion" => $seccion,
      ...
      #MEDIA HORAS
      if (
         $mediaHoras > 0 && $creadosGlobales > 0
      )
         $mediaHoras = $mediaHoras / $creadosGlobales;
      else
         $mediaHoras = 0;
      ...
      $ratioCredas = 0;
      if (
         $habitaciones > 0 && $creadosGlobales > 0
      )
         $ratioCredas = $creadosGlobales / $habitaciones;
   ...
   // REPORTE DE INCIDENCIAS POR DESTINO Y SUBSECCIONES (PENDIENTES)
   public static function destinosPendientesSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // REPORTE DE INCIDENCIAS POR DESTINO Y SUBSECCIONES (SOLUCIONADOS)
   public static function destinosSolucionadosSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // REPORTE DE INCIDENCIAS POR DESTINO Y SUBSECCIONES (ACUMULADO)
   public static function destinosCreadosSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // REPORTE DE INCIDENCIAS POR DESTINO Y SUBSECCIONES (CREADOS)
   public static function mcmpCreadosSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // GRAFICA POR DESTINO
   public static function graficaIncidencias($idDestino, $fechaInicio, $fechaFin)
   {
      $array = array();
   ...
   // GRAFICA POR DESTINO
   public static function graficaIncidenciasSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $array = array();
      $meses = ['', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'];
      $fechaInicioX = strtotime($fechaInicio);
      ...
      while ($fechaInicioX <= $fechaFinX) {
         ...
         $incidencias = Incidencias::totalRangoFechaStatus($idDestino, $idSeccion, 0, $fechaA, $fechaB, 'CREADO', 'TODOS');
         foreach ($incidencias as $x) {
            $status = $x['status'];
         ...
         $incidenciasGeneradas = IncidenciasGenerales::totalRangoFechaStatus($idDestino, $idSeccion, 0, $fechaA, $fechaB, 'CREADO', 'TODOS');
         foreach ($incidenciasGeneradas as $x) {
            $status = $x['status'];
   ...
   public static function mpSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      ...
      $ratioCredas = 0;
      if (
         $habitaciones > 0 && $creadasGlobal > 0
      )
         $ratioCredas = $creadasGlobal / $habitaciones;
   ...
   public static function mpGraficaSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      // DATOS PARA GRAFICAR PREVENTIVOS
      ...
      while ($fechaInicioX <= $fechaFinX) {
         ...
         $mp = MP::totalRangoFechaStatus($idDestino, $idSeccion, 0, $fechaA, $fechaB, 'CREADO', 'TODOS');
         foreach ($mp as $x) {
            $status = $x['status'];
   ...
   // REPORTE DE PREVENTIVOS POR DESTINO (CREADOS)
   public static function mpCreadosSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // REPORTE DE PREVENTIVOS POR DESTINO (SOLUCIONADOS)
   public static function mpSolucionadosSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // REPORTE DE PREVENTIVOS POR DESTINO (CREADOS)
   public static function mpPendientesSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   // REPORTE DE INCIDENCIAS POR DESTINO (SOLUCIONADOS)
   public static function mpmcCreadosSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
   ...
   public static function MPvsMCSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin, $status)
   {
      $conexion = new Conexion();
      $conexion->conectar();
      ...
      foreach ($subsecciones as $x) {
         ...
         #DATA
         if ($idSeccion != 1001 && $idSubseccion != 200)
            $array['secciones'][] = array(
               "idSeccion" => $idSeccion,
               "seccion" => $seccion,
               "idSubseccion" => $idSubseccion,
   ...
   public static function mpPlaneacionesSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
      $array = array();
      ...
      foreach ($subsecciones as $x) {
         ...
         $planeacion = MP::mpPlanificaciones($idDestino, 0, $idSeccionX, $idSubseccion, $fechaInicio, $fechaFin);
         $totalConPlanificaciones = $planeacion['totalConPlanificacionesGlobal'];
         $totalSinPlanificaciones = $planeacion['totalSinPlanificacionesGlobal'];
         $totalPlanificaciones = $planeacion['totalPlanificacionesGlobal'];
         $totalSemanasPlanificadas = $planeacion['totalSemanasPlanificadasGlobal'];
   ...
   public static function mpPlanificacionesEquiposSubsecciones($idDestino, $idSeccion, $fechaInicio, $fechaFin)
   {
      $conexion = new Conexion();
      $conexion->conectar();
      $array = array();
      ...
      #DATOS GLOBLES
      $totalEquipos = count(Equipos::equiposFiltrados(0, $idDestino, $idSeccion, 0, 'OPERATIVO'));
      $totalEquiposPlanificadosGlobal = 0;
      $totalEquiposPlanCompleto = 0;

      $planeaciones = MP::mpPlanificacionesEquipos($idDestino, 0, $idSeccion, 0, $fechaInicio, $fechaFin);
      foreach ($planeaciones as $x) {

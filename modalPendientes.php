...
<body class="bg-gray-200" style="font-family: 'Roboto', sans-serif;">
            ...
            <div class=" flex flex-col items-center justify-center">
                <div class="absolute top-0 left-0 flex flex-row">
                    <div>
                        ...
                        <div id="btnExpandirMenutoggle"
                            ...
                            <a onclick="exportarPendientes(<?= $exportarMisPendientes; ?>);" id="exportarMisPendientes"
                                href="#" class="py-1 px-2 w-full hover:bg-gray-700">Mis
                                Pendientes (EXCEL)</a>

                            <a onclick="exportarPendientes(<?= $exportarSeccion; ?>);" id="exportarSeccion" href="#"
                                class="py-1 px-2 w-full hover:bg-gray-700">Sección
                                completa (EXCEL)</a>

                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="toggleSubseccionesTipo('modalExportarSubsecciones', 'subseccionesEXCEL', 'subseccionesPDF');">Subsecciones
                                (EXCEL)</a>

                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="exportarPorUsuario(<?= $exportarPorResponsable; ?>);">Responsable
                                (EXCEL)</a>

                            <a onclick="exportarPendientes(<?= $exportarMisCreados; ?>);" id="exportarMisPendientes"
                                href="#" class="py-1 px-2 w-full hover:bg-gray-700">
                                Creados Por Mi (EXCEL)</a>

                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="exportarPorUsuario(<?= $exportarCreadosDe; ?>);">Creados Por (EXCEL)</a>

                            <a onclick="exportarPendientes(<?= $exportarMisPendientesPDF; ?>);"
                                id="exportarMisPendientesPDF" href="#" class="py-1 px-2 w-full hover:bg-gray-700">
                                Mis Pendientes (PDF)</a>

                            <a onclick="exportarPendientes(<?= $exportarMisCreadosPDF; ?>);"
                                id="exportarMisPendientesPDF" href="#" class="py-1 px-2 w-full hover:bg-gray-700">
                                Creado Por Mi (PDF)</a>

                            <a id="exportarMisPendientesPDF" href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="toggleSubseccionesTipo('modalExportarSubsecciones', 'subseccionesPDF', 'subseccionesEXCEL');">
                                Subsección (PDF)</a>

                            <a href="#" class="py-1 px-2 w-full hover:bg-gray-700"
                                onclick="exportarPorUsuario(<?= $exportarCreadosPorPDF; ?>);">Colaborador(PDF)</a>
                        </div>
                    </div>
                    <div class="ml-3">
                        ...
                        <div id="btnvisualizarpendientesdetoggle"
                            ...
                            <a id="misPendientesCreados" onclick="pendientesSeccion(<?= $misPendientesCreado; ?>);"
                                href="#" class="py-1 px-2 w-full hover:bg-gray-700">Creados Por Mi</a>

                            <a id="misPendientesUsuario" onclick="pendientesSeccion(<?= $misPendientesUsuario; ?>);"
                                href="#" class="py-1 px-2 w-full hover:bg-gray-700">Mis Pendientes</a>

                            <a id="misPendientesSinUsuario"
                                onclick="pendientesSeccion(<?= $misPendientesSinUsuario; ?>);" href="#"
                                class="py-1 px-2 w-full hover:bg-gray-700">Sin Responsable</a>

                            <a id="misPendientesSeccion" onclick="pendientesSeccion(<?= $misPendientesSeccion; ?>);"
                                href="#" class="py-1 px-2 w-full hover:bg-gray-700">Todos</a>
                ...
                <div class="flex flex-row text-sm bg-white mt-4">
                    <div class="py-1 px-2 rounded-l-md bg-red-200 text-red-500 font-normal cursor-pointer"
                        onclick="mostrarOpcion('pendientesFallasTareas');">
                    ...
                    <div class="py-1 px-2 rounded-r-md bg-gray-200 text-gray-900 hover:bg-red-200 hover:text-red-500 font-normal cursor-pointer"
                        onclick="mostrarOpcion('diagramaGantt');">
                        <h1>Proyectos</h1>
                    </div>
                </div>
            </div>
    ...
    <div id="modalExportarSubsecciones" class="modal">
        <div class="modal-window rounded-md pt-10" style="width: 370px;">
            ...
            <!-- CONTENIDO -->
            <div id="subseccionesEXCEL"
                class="hidden p-2 flex flex-col justify-center items-center flex-col w-full pb-6">
            ...
            success: function(data) {
                ...
                if (tipoPendiente == "FALLA") {
                    ...
                    setAttribute('onclick',
                        'obtenerFechaTareas(' + idPendiente + ', "' + data.fecha + '")');
                    document.getElementById("fechaVP").innerHTML = data.fecha;
                    document.getElementById("fechaTareas").value = data.fecha;

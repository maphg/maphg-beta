...
<body class="bg-purple-400 h-screen scrollbar">
    <!-- MENÚ -->
    <menu-menu></menu-menu>
    ...
    <div class="flex flex-col md:flex-row">
        <div class="w-1/2 h-0 md:h-screen flex flex-col items-center justify-center">
            <div class="bg-white w-40 h-40 rounded-full flex items-center justify-center">
                <div class="text-purple-700 bg-purple-400 font-medium flex justify-center items-center shadow-md rounded-lg text-2xl w-20 h-20">
                    <h1 class="">DEC</h1>
                </div>
            </div>
            <h1 class="font-bold text-3xl text-purple-700">CONSULTORÍA</h1>
        </div>
        <iframe class="w-full md:w-1/2 h-screen pb-20" src="https://chatbro.com/46j7f" frameborder="0"></iframe>
    </div>

...
<head>
    ...
    <title>MAPHG Gestión Planes</title>
        ...
        <div class="modal-window w-10/12 flex shadow-lg flex-col justify-center items-center mx-auto text-bluegray-800 pt-10 rounded-lg">
            ...
            <div class="p-2 flex justify-center items-start flex-row w-full flex-wrap">
                ...
                <div class="w-1/5 px-3 mb-4">
                    ...
                    <div class="relative">
                        <div class="relative">
                            <input id="dataTiempoActividadPlanMP" placeholder="En minutos" type="number" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" min="0" value="1">
                ...
                <div id="infoActividadPlanMP" class="hidden w-full bg-bluegray-900 rounded flex flex-col p-6">
                    ...
                    <div class="w-full flex flex-row justify-around mb-6">
                        ...
                        <div class="w-1/2 bg-white px-4 py-2 rounded flex flex-col">
                            <h1 class="font-bold text-center">Así es como se verá en la OT</h1>
                            <h1 class="text-left p-2 border-2 mt-4 rounded border-purple-500"><i class="far fa-circle"></i> si - <i class="far fa-circle"></i> no - <i class="far fa-circle"></i> n/a <span class="font-bold uppercase ml-4">¿El WC
                    ...
                    <div class="w-full flex flex-row justify-around mb-6">
                        ...
                        <div class="w-1/2 bg-white px-4 py-2 rounded flex flex-col">
                            <h1 class="font-bold text-center">Así es como se verá en la OT</h1>
                            <h1 class="text-left p-2 border-2 mt-4 rounded border-orange-500"><span class="font-bold uppercase ml-4">_____________ VOLTAJE DE ENTRADA DEL EQUIPO</span>
                            </h1>
                        </div>
                    </div>

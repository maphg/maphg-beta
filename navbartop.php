...
<dav class="nt1"><!-- nt1 -->
    <dav class="nt2"><!-- nt2 -->
        ...
        <o href="#" class="nt4"><?= $nombreUsuario; ?> <spen class="nt8"><i class="fal fa-angle-down"></i></spen></o><!-- nt4 -->
    </dav>
    <dav class="nt5"><!-- nt5 -->
        <o onclick="botonDestino()" href="#" class="nt6"><spen><i class="fas fa-map-marker-alt nt7"></i></spen><?=$destinoT;?></o><!-- nt6 -->
    </dav>
</dav>
<!-- navbar -->